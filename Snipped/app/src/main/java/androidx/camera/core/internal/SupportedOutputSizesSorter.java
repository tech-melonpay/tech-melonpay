...
class SupportedOutputSizesSorter {
    ...
    public static Rational getTargetAspectRatioRationalValue(int i, boolean z10) {
        if (i != -1) {
            if (i == 0) {
    ...
    public static void sortSupportedSizesByFallbackRuleClosestHigherThenLower(List<Size> list, Size size, boolean z10) {
        ArrayList arrayList = new ArrayList();
    ...
    private static void sortSupportedSizesByFallbackRuleClosestLowerThenHigher(List<Size> list, Size size, boolean z10) {
        ArrayList arrayList = new ArrayList();
    ...
    public List<Size> getSortedSupportedOutputSizes(UseCaseConfig<?> useCaseConfig) {
        ...
        return customOrderedResolutions != null ? customOrderedResolutions : imageOutputConfig.getResolutionSelector(null) == null ? this.mSupportedOutputSizesSorterLegacy.sortSupportedOutputSizes(getResolutionCandidateList(useCaseConfig), useCaseConfig) : sortSupportedOutputSizesByResolutionSelector(useCaseConfig);
    }
}
