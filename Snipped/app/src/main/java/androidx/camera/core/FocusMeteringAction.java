...
public final class FocusMeteringAction {
    ...
    public static class Builder {
        ...
        public Builder setAutoCancelDuration(long j10, TimeUnit timeUnit) {
            C1124b.m(j10 >= 1, "autoCancelDuration must be at least 1");
        ...
        public Builder addPoint(MeteringPoint meteringPoint, int i) {
            boolean z10 = false;
            C1124b.m(meteringPoint != null, "Point cannot be null.");
            if (i >= 1 && i <= 7) {
                z10 = true;
            }
            C1124b.m(z10, "Invalid metering mode " + i);
            if ((i & 1) != 0) {
