...
public abstract class SurfaceConfig {
    ...
    public static SurfaceConfig transformSurfaceConfig(int i, int i9, Size size, SurfaceSizeDefinition surfaceSizeDefinition) {
        ConfigType configType = getConfigType(i9);
    ...
    public static SurfaceConfig create(ConfigType configType, ConfigSize configSize, long j10) {
        return new AutoValue_SurfaceConfig(configType, configSize, j10);
    }
}
