...
class SupportedOutputSizesSorterLegacy {
    ...
    private static Size flipSizeByRotation(Size size, int i, int i9, int i10) {
        return (size == null || !isRotationNeeded(i, i9, i10)) ? size : new Size(size.getHeight(), size.getWidth());
    }
    ...
    private static boolean isRotationNeeded(int i, int i9, int i10) {
        int relativeImageRotation = CameraOrientationUtil.getRelativeImageRotation(CameraOrientationUtil.surfaceRotationToDegrees(i), i10, 1 == i9);
