...
public final class F extends H {
    ...
    public final int b(View view) {
        return this.f7423a.getDecoratedRight(view) + ((ViewGroup.MarginLayoutParams) ((RecyclerView.o) view.getLayoutParams())).rightMargin;
    }
    ...
    public final int e(View view) {
        return this.f7423a.getDecoratedLeft(view) - ((ViewGroup.MarginLayoutParams) ((RecyclerView.o) view.getLayoutParams())).leftMargin;
    }

    @Override // androidx.recyclerview.widget.H
    public final int f() {
        return this.f7423a.getWidth();
    }
    ...
    @Override // androidx.recyclerview.widget.H
    public final int h() {
        return this.f7423a.getPaddingRight();
    }
    ...
    @Override // androidx.recyclerview.widget.H
    public final int k() {
        return this.f7423a.getPaddingLeft();
    }

    @Override // androidx.recyclerview.widget.H
    public final int l() {
        RecyclerView.n nVar = this.f7423a;
        return (nVar.getWidth() - nVar.getPaddingLeft()) - nVar.getPaddingRight();
    }
    ...
    public final void p(int i) {
        this.f7423a.offsetChildrenHorizontal(i);
    }
}
