...
/* compiled from: FragmentCreateNewCardVaultBindingImpl.java */
/* renamed from: t6.z3, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1484z3 extends AbstractC1477y3 {

    /* renamed from: z, reason: collision with root package name */
    public static final SparseIntArray f29895z;
    ...
    static {
        ...
        f29895z = sparseIntArray;
        sparseIntArray.put(R.id.nestedScrollView, 1);
        sparseIntArray.put(R.id.vaultNameInputLayout, 2);
        sparseIntArray.put(R.id.vaultNameInputView, 3);
        sparseIntArray.put(R.id.infoVaultLayout, 4);
        sparseIntArray.put(R.id.vaultTypeInputLayout, 5);
        sparseIntArray.put(R.id.vaultTypeInputView, 6);
        sparseIntArray.put(R.id.img_arrow_from, 7);
        sparseIntArray.put(R.id.infoLayout, 8);
        sparseIntArray.put(R.id.accountInputLayout, 9);
        sparseIntArray.put(R.id.accountInputView, 10);
        sparseIntArray.put(R.id.accountArrowFromImageView, 11);
        sparseIntArray.put(R.id.accountCurrencyImageView, 12);
        sparseIntArray.put(R.id.tvBalance, 13);
        sparseIntArray.put(R.id.buttonDone, 14);
        sparseIntArray.put(R.id.buttonDoneK, 15);
    }
    ...
    */
    public C1484z3(F0.c r18, android.view.View r19) {
        /*
            r17 = this;
            r15 = r17
            r0 = r19
            android.util.SparseIntArray r1 = t6.C1484z3.f29895z
            r2 = 16
            ...
            r1 = r16[r1]
            r10 = r1
            com.luminary.business.presentation.ui.views.InfoView r10 = (com.luminary.business.presentation.ui.views.InfoView) r10
            r1 = 1
            r1 = r16[r1]
            ...
            r1 = r16[r1]
            r13 = r1
            com.luminary.business.presentation.ui.views.customtextinput.CustomTextInputEditText r13 = (com.luminary.business.presentation.ui.views.customtextinput.CustomTextInputEditText) r13
            r1 = 5
            r1 = r16[r1]
            ...
            monitor-enter(r17)
            r0 = 1
            r15.f29896y = r0     // Catch: java.lang.Throwable -> L8d
        ...
        L8d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: t6.C1484z3.<init>(F0.c, android.view.View):void");
    }
