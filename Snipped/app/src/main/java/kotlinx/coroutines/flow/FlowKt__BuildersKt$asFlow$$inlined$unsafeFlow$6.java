...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6<T> implements Flow<T> {
    ...
    @V9.d(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6", f = "Builders.kt", l = {111}, m = "collect")
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r8, T9.a<? super O9.p> r9) {
        /*
            r7 = this;
        ...
        L5f:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6.collect(kotlinx.coroutines.flow.FlowCollector, T9.a):java.lang.Object");
    }
}
