...
public final class FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    final /* synthetic */ InterfaceC0651q $operation$inlined;
    final /* synthetic */ Flow $this_runningFold$inlined;

    @V9.d(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1", f = "Transform.kt", l = {110, 111}, m = "collect")
    ...
    public FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1(Object obj, Flow flow, InterfaceC0651q interfaceC0651q) {
        this.$initial$inlined = obj;
        this.$this_runningFold$inlined = flow;
        this.$operation$inlined = interfaceC0651q;
    }
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super R> r7, T9.a<? super O9.p> r8) {
        /*
            r6 = this;
        ...
        L79:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1.collect(kotlinx.coroutines.flow.FlowCollector, T9.a):java.lang.Object");
    }
}
