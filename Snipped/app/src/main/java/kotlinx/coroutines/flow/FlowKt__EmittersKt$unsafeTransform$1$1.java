...
public final class FlowKt__EmittersKt$unsafeTransform$1$1<T> implements FlowCollector {
    ...
    public FlowKt__EmittersKt$unsafeTransform$1$1(InterfaceC0651q<? super FlowCollector<? super R>, ? super T, ? super T9.a<? super p>, ? extends Object> interfaceC0651q, FlowCollector<? super R> flowCollector) {
    ...
    */
    public final java.lang.Object emit(T r5, T9.a<? super O9.p> r6) {
        ...
        L3f:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__EmittersKt$unsafeTransform$1$1.emit(java.lang.Object, T9.a):java.lang.Object");
    }

    public final Object emit$$forInline(T t3, T9.a<? super p> aVar) {
        new FlowKt__EmittersKt$unsafeTransform$1$1$emit$1(this, aVar);
        this.$transform.invoke(this.$this_unsafeFlow, t3, aVar);
        return p.f3034a;
    }
}
