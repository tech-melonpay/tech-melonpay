...
@V9.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4", f = "Zip.kt", l = {269}, m = "invokeSuspend")
...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4<R> extends SuspendLambda implements InterfaceC0650p<FlowCollector<? super R>, T9.a<? super p>, Object> {
    ...
    /* compiled from: Zip.kt */
    @V9.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4$1", f = "Zip.kt", l = {270}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements InterfaceC0651q<FlowCollector<? super R>, Object[], T9.a<? super p>, Object> {
        ...
        public AnonymousClass1(T9.a aVar, t tVar) {
            super(3, aVar);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (tVar.invoke(flowCollector, obj2, obj3, obj4, obj5, this) == coroutineSingletons) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4(Flow[] flowArr, T9.a aVar, t tVar) {
        super(2, aVar);
        this.$flows = flowArr;
        this.$transform$inlined = tVar;
    }
    ...
    public final T9.a<p> create(Object obj, T9.a<?> aVar) {
        FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4 flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4 = new FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4(this.$flows, aVar, this.$transform$inlined);
    ...
    public final Object invoke(FlowCollector<? super R> flowCollector, T9.a<? super p> aVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$4) create(flowCollector, aVar)).invokeSuspend(p.f3034a);
    }
}
