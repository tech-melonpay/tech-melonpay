...
@V9.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1", f = "Zip.kt", l = {269}, m = "invokeSuspend")
...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1<R> extends SuspendLambda implements InterfaceC0650p<FlowCollector<? super R>, T9.a<? super p>, Object> {
    ...
    /* compiled from: Zip.kt */
    @V9.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1$1", f = "Zip.kt", l = {270}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements InterfaceC0651q<FlowCollector<? super R>, Object[], T9.a<? super p>, Object> {
        ...
        public AnonymousClass1(T9.a aVar, InterfaceC0652r interfaceC0652r) {
            super(3, aVar);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (interfaceC0652r.invoke(flowCollector, obj2, obj3, this) == coroutineSingletons) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(Flow[] flowArr, T9.a aVar, InterfaceC0652r interfaceC0652r) {
        super(2, aVar);
        this.$flows = flowArr;
        this.$transform$inlined = interfaceC0652r;
    }
    ...
    public final T9.a<p> create(Object obj, T9.a<?> aVar) {
        FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 = new FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(this.$flows, aVar, this.$transform$inlined);
    ...
    public final Object invoke(FlowCollector<? super R> flowCollector, T9.a<? super p> aVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1) create(flowCollector, aVar)).invokeSuspend(p.f3034a);
    }
}
