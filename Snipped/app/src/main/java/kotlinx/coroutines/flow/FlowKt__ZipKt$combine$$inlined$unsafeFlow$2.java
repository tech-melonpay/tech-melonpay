...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$2(Flow[] flowArr, InterfaceC0650p interfaceC0650p) {
    ...
    public Object collect$$forInline(FlowCollector flowCollector, T9.a aVar) {
        new ContinuationImpl(aVar) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2.1
            int label;
