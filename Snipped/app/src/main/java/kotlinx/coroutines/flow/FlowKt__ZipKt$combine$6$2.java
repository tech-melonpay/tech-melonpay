...
@V9.d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2", f = "Zip.kt", l = {288, 288}, m = "invokeSuspend")
...
public final class FlowKt__ZipKt$combine$6$2<R, T> extends SuspendLambda implements InterfaceC0651q<FlowCollector<? super R>, T[], T9.a<? super p>, Object> {
    ...
    public FlowKt__ZipKt$combine$6$2(InterfaceC0650p<? super T[], ? super T9.a<? super R>, ? extends Object> interfaceC0650p, T9.a<? super FlowKt__ZipKt$combine$6$2> aVar) {
        super(3, aVar);
