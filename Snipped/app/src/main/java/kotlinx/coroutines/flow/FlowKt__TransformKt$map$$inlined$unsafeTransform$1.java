...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @V9.d(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", f = "Transform.kt", l = {50, 50}, m = "emit")
        @Metadata(k = 3, mv = {2, 0, 0}, xi = CipherSuite.TLS_PSK_WITH_NULL_SHA256)
        ...
        */
        public final java.lang.Object emit(T r7, T9.a<? super O9.p> r8) {
            ...
            L5b:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.AnonymousClass2.emit(java.lang.Object, T9.a):java.lang.Object");
        }

        /* JADX WARN: Multi-variable type inference failed */
        public final Object emit$$forInline(Object obj, T9.a aVar) {
            new AnonymousClass1(aVar);
            this.$this_unsafeFlow.emit(this.$transform$inlined.invoke(obj, aVar), aVar);
            return p.f3034a;
        }
    }

    public FlowKt__TransformKt$map$$inlined$unsafeTransform$1(Flow flow, InterfaceC0650p interfaceC0650p) {
    ...
    public Object collect$$forInline(FlowCollector flowCollector, T9.a aVar) {
        new ContinuationImpl(aVar) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.1
            int label;
            /* synthetic */ Object result;
