...
public final class ChannelResult<T> {
    ...
    public static final class Closed extends Failed {
        ...
        public boolean equals(Object other) {
            return (other instanceof Closed) && kotlin.jvm.internal.f.b(this.cause, ((Closed) other).cause);
        }
    ...
    public static final class Companion {
        ...
        public final <E> Object m137closedJP2dKIU(Throwable cause) {
            return ChannelResult.m125constructorimpl(new Closed(cause));
        }

        @InternalCoroutinesApi
        /* renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m138failurePtdJZtk() {
            return ChannelResult.m125constructorimpl(ChannelResult.failed);
        }

        @InternalCoroutinesApi
        /* renamed from: success-JP2dKIU, reason: not valid java name */
        public final <E> Object m139successJP2dKIU(E value) {
            return ChannelResult.m125constructorimpl(value);
        }
    ...
    public static final /* synthetic */ ChannelResult m124boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m126equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && kotlin.jvm.internal.f.b(obj, ((ChannelResult) obj2).getHolder());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m127equalsimpl0(Object obj, Object obj2) {
        return kotlin.jvm.internal.f.b(obj, obj2);
    }
    ...
    public static final T m129getOrNullimpl(Object obj) {
    ...
    public static final T m130getOrThrowimpl(Object obj) {
        Throwable th;
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static int m131hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m132isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m133isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* renamed from: isSuccess-impl, reason: not valid java name */
    public static final boolean m134isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m135toStringimpl(Object obj) {
    ...
    public boolean equals(Object other) {
        return m126equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m131hashCodeimpl(this.holder);
    }

    public String toString() {
        return m135toStringimpl(this.holder);
    }
