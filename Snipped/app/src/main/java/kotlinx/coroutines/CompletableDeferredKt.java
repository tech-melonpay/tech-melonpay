...
public final class CompletableDeferredKt {
    ...
    public static final <T> boolean completeWith(CompletableDeferred<T> completableDeferred, Object obj) {
        ...
        return a10 == null ? completableDeferred.complete(obj) : completableDeferred.completeExceptionally(a10);
    }

    public static final <T> CompletableDeferred<T> CompletableDeferred(T t3) {
