...
public final class p {
    ...
    public static void a(int i, int i9, int i10) {
        ...
        a aVar2 = f847c;
        while (true) {
            a[] aVarArr = aVar2.f848a;
            if (i10 <= 8) {
                int i11 = 8 - i10;
                int i12 = (i9 << i11) & 255;
                Arrays.fill(aVarArr, i12, (1 << i11) + i12, aVar);
                return;
            } else {
                i10 -= 8;
                int i13 = (i9 >>> i10) & 255;
