...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    private static String createKey(String str, int i, int i9, int i10, int i11, int i12) {
        if (str == null) {
            throw new NullPointerException("algorithmName == null");
        }
        return str + "-" + i + "-" + i9 + "-" + i10 + "-" + i11 + "-" + i12;
    }

    public static DefaultXMSSMTOid lookup(String str, int i, int i9, int i10, int i11, int i12) {
        if (str != null) {
            return oidLookupTable.get(createKey(str, i, i9, i10, i11, i12));
        }
        throw new NullPointerException("algorithmName == null");
    }
