...
public class XMSS {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.x(a.o(sb2, aSN1ObjectIdentifier, configurableProvider, "XMSS", "Alg.Alias.Signature.OID."), aSN1ObjectIdentifier, configurableProvider, "XMSS");
            ...
            a.x(a.o(sb3, aSN1ObjectIdentifier2, configurableProvider, "XMSSMT", "Alg.Alias.Signature.OID."), aSN1ObjectIdentifier2, configurableProvider, "XMSSMT");
