...
public final class DefaultXMSSOid implements XMSSOid {
    ...
    private static String createKey(String str, int i, int i9, int i10, int i11) {
        if (str == null) {
    ...
    public static DefaultXMSSOid lookup(String str, int i, int i9, int i10, int i11) {
        if (str != null) {
            return oidLookupTable.get(createKey(str, i, i9, i10, i11));
        }
        throw new NullPointerException("algorithmName == null");
    }
