...
public class McElieceKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        ...
        try {
            ...
            throw new InvalidKeySpecException(v.m("Unable to decode PKCS8EncodedKeySpec: ", e10));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidKeySpecException(a.b(e10, new StringBuilder("Unable to decode X509EncodedKeySpec: ")));
            }
    ...
    public KeySpec getKeySpec(Key key, Class cls) {
        ...
        throw new InvalidKeySpecException(androidx.camera.core.impl.utils.a.l("Unknown key specification: ", cls, "."));
    }
