...
public class McEliece {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.x(a.o(new StringBuilder("KeyFactory."), PQCObjectIdentifiers.mcElieceCca2, configurableProvider, "org.bouncycastle.pqc.jcajce.provider.mceliece.McElieceCCA2KeyFactorySpi", "KeyFactory."), PQCObjectIdentifiers.mcEliece, configurableProvider, "org.bouncycastle.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi");
