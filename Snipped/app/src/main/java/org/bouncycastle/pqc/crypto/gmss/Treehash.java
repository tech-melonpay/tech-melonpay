...
public class Treehash {
    ...
    public int[] getStatInt() {
        ...
        for (int i9 = 0; i9 < this.tailLength; i9++) {
            iArr[i9 + 6] = ((Integer) this.heightOfNodes.elementAt(i9)).intValue();
        }
        return iArr;
    }
    ...
    public void initialize() {
        if (!this.seedInitialized) {
            throw new IllegalStateException(b.m(new StringBuilder("Seed "), this.maxHeight, " not initialized"));
        }
    ...
    public String toString() {
        ...
        for (int i9 = 0; i9 < this.tailLength + 3; i9++) {
            str = getStatByte()[i9] != null ? a.n(v.s(str), new String(Hex.encode(getStatByte()[i9])), " ") : v.n(str, "null ");
        }
        StringBuilder r8 = a.r(str, "  ");
        r8.append(this.messDigestTree.getDigestSize());
        return r8.toString();
    }
    ...
    public Treehash(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        for (int i9 = 0; i9 < this.tailLength; i9++) {
            this.tailStack.addElement(bArr[i9 + 3]);
        }
    }
}
