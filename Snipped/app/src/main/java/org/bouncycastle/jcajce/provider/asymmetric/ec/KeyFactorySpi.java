...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        ...
        try {
            ...
            throw new InvalidKeySpecException(a.b(e10, new StringBuilder("bad encoding: ")));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        try {
            ...
            throw new InvalidKeySpecException(v.l(e10, new StringBuilder("invalid KeySpec: ")), e10);
        }
    }
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) {
        ...
        try {
            ...
            throw new IllegalArgumentException(a.b(e11, new StringBuilder("cannot encoded key: ")));
        }
    }
