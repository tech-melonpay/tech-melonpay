...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) {
        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (!z10 && !(algorithmParameterSpec instanceof MQVParameterSpec)) {
                ...
                throw new InvalidAlgorithmParameterException(a.n(sb2, getSimpleName(MQVParameterSpec.class), " for initialisation"));
            }
            if (z10) {
        ...
        if (!(algorithmParameterSpec instanceof DHUParameterSpec)) {
            if (!(key instanceof PrivateKey)) {
                ...
                throw new InvalidKeyException(a.n(sb3, getSimpleName(ECPrivateKey.class), " for initialisation"));
            }
    ...
    public Key engineDoPhase(Key key, boolean z10) {
        ...
        try {
            ...
            throw new InvalidKeyException(v.l(e10, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
