...
public class BaseStreamCipher extends BaseWrapCipher implements PBE {
    ...
    public int engineDoFinal(byte[] bArr, int i, int i9, byte[] bArr2, int i10) {
        ...
        if (i9 != 0) {
            this.cipher.processBytes(bArr, i, i9, bArr2, i10);
        }
        this.cipher.reset();
        return i9;
    }
    ...
    public BaseStreamCipher(StreamCipher streamCipher, int i, int i9) {
        this(streamCipher, i, i9, -1);
    }
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i9) {
        ...
        byte[] engineUpdate = engineUpdate(bArr, i, i9);
        this.cipher.reset();
        return engineUpdate;
    }
    ...
    public BaseStreamCipher(StreamCipher streamCipher, int i, int i9, int i10) {
