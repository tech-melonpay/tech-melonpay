...
public final class DES {
    ...
    public static class DESPBEKeyFactory extends BaseSecretKeyFactory {
        ...
        public DESPBEKeyFactory(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z10, int i, int i9, int i10, int i11) {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.v(sb2, str, "$ECB", configurableProvider, "Cipher.DES");
            ...
            sb3.append(str);
            a.w(a.m(a.m(a.m(sb3, "$KeyGenerator", configurableProvider, "KeyGenerator.DES", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DES", str), "$CMAC", configurableProvider, "Mac.DESCMAC", str), "$CBCMAC", configurableProvider, "Mac.DESMAC");
            configurableProvider.addAlgorithm("Mac.DESMAC/CFB8", a.k(configurableProvider, "Alg.Alias.Mac.DES", "DESMAC", str, "$DESCFB8"));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DES/CFB8", "DESMAC/CFB8");
            a.v(new StringBuilder(), str, "$DES64", configurableProvider, "Mac.DESMAC64");
            configurableProvider.addAlgorithm("Mac.DESMAC64WITHISO7816-4PADDING", a.k(configurableProvider, "Alg.Alias.Mac.DES64", "DESMAC64", str, "$DES64with7816d4"));
            ...
            a.v(new StringBuilder(), str, "$DES9797Alg3", configurableProvider, "Mac.DESWITHISO9797");
            configurableProvider.addAlgorithm("Mac.ISO9797ALG3MAC", a.k(configurableProvider, "Alg.Alias.Mac.DESISO9797MAC", "DESWITHISO9797", str, "$DES9797Alg3"));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.ISO9797ALG3", "ISO9797ALG3MAC");
            a.v(new StringBuilder(), str, "$DES9797Alg3with7816d4", configurableProvider, "Mac.ISO9797ALG3WITHISO7816-4PADDING");
            ...
            StringBuilder q10 = a.q(configurableProvider, "Alg.Alias.AlgorithmParameters", "DES", str, aSN1ObjectIdentifier);
            q10.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.DES", q10.toString());
            a.w(a.m(a.m(a.B(new StringBuilder("Alg.Alias.AlgorithmParameterGenerator."), "DES", configurableProvider, str, aSN1ObjectIdentifier), "$PBEWithMD2", configurableProvider, "Cipher.PBEWITHMD2ANDDES", str), "$PBEWithMD5", configurableProvider, "Cipher.PBEWITHMD5ANDDES", str), "$PBEWithSHA1", configurableProvider, "Cipher.PBEWITHSHA1ANDDES");
            ...
            a.v(a.l(a.l(new StringBuilder(), str, "$PBEWithMD2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD2ANDDES"), str, "$PBEWithMD5KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD5ANDDES"), str, "$PBEWithSHA1KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHA1ANDDES");
            ...
            a.x(a.o(new StringBuilder("Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier3, configurableProvider, "PBEWITHMD5ANDDES", "Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier4, configurableProvider, "PBEWITHSHA1ANDDES");
        }
    }
