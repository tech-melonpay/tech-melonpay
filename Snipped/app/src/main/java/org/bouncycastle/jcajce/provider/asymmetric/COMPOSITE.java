...
public class COMPOSITE {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder p10 = a.p(configurableProvider, "KeyFactory.COMPOSITE", "org.bouncycastle.jcajce.provider.asymmetric.COMPOSITE$KeyFactory", "KeyFactory.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = MiscObjectIdentifiers.id_alg_composite;
            StringBuilder o10 = a.o(p10, aSN1ObjectIdentifier, configurableProvider, "org.bouncycastle.jcajce.provider.asymmetric.COMPOSITE$KeyFactory", "KeyFactory.OID.");
            o10.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(o10.toString(), "org.bouncycastle.jcajce.provider.asymmetric.COMPOSITE$KeyFactory");
