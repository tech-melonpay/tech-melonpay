...
public class ECGOST {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.x(a.p(configurableProvider, "Alg.Alias.KeyAgreement.GOST-3410-2001", "ECGOST3410", "Alg.Alias.KeyAgreement."), CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_ESDH, configurableProvider, "ECGOST3410");
            ...
            a.x(a.o(a.o(new StringBuilder("Alg.Alias.KeyAgreement."), aSN1ObjectIdentifier5, configurableProvider, "ECGOST3410-2012-512", "Alg.Alias.KeyAgreement."), aSN1ObjectIdentifier2, configurableProvider, "ECGOST3410-2012-256", "Alg.Alias.KeyAgreement."), aSN1ObjectIdentifier4, configurableProvider, "ECGOST3410-2012-512");
        }
    }
}
