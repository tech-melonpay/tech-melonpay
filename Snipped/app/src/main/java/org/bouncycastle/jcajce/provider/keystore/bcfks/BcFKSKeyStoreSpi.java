...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
        ...
        public Key engineGetKey(String str, char[] cArr) {
            try {
                ...
                if (this.cache.containsKey(str) && !Arrays.constantTimeAreEqual(this.cache.get(str), calculateMac)) {
                    throw new UnrecoverableKeyException(n.a("unable to recover key (", str, ")"));
                }
                ...
                StringBuilder m2 = a.m("unable to recover key (", str, "): ");
                m2.append(e10.getMessage());
                throw new UnrecoverableKeyException(m2.toString());
            }
        }
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i) {
        ...
        throw new IllegalStateException(org.bouncycastle.asn1.a.f("unknown derivation algorithm: ", aSN1ObjectIdentifier));
    }
    ...
    public Key engineGetKey(String str, char[] cArr) {
        ...
        if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
            if (!objectData.getType().equals(SECRET_KEY) && !objectData.getType().equals(PROTECTED_SECRET_KEY)) {
                throw new UnrecoverableKeyException(n.a("BCFKS KeyStore unable to recover secret key (", str, "): type not recognized"));
            }
            ...
            try {
                ...
                throw new UnrecoverableKeyException(v.l(e10, a.m("BCFKS KeyStore unable to recover secret key (", str, "): ")));
            }
        }
        ...
        try {
            ...
            throw new UnrecoverableKeyException(v.l(e11, a.m("BCFKS KeyStore unable to recover private key (", str, "): ")));
        }
    }
        ...
        try {
            ...
            if (integrityCheck.getType() == 0) {
                ...
                try {
                    ...
                    throw new IOException(androidx.camera.core.impl.utils.a.p(e11, new StringBuilder("error verifying signature: ")), e11);
                }
            }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) {
        ...
        if (objectData == null) {
            ...
            if (!objectData.getType().equals(CERTIFICATE)) {
                throw new KeyStoreException(b.j("BCFKS KeyStore already has a key entry with alias ", str));
            }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(org.bouncycastle.asn1.a.c(e10, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e10);
            }
        } else {
            ...
            try {
                ...
                throw new ExtKeyStoreException(org.bouncycastle.asn1.a.c(e11, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e11);
            }
        }
        this.lastModifiedDate = date;
    }
    ...
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) {
        ...
        try {
            ...
            throw new IOException(androidx.camera.core.impl.utils.a.p(e10, new StringBuilder("error creating signature: ")), e10);
        }
    }
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(org.bouncycastle.asn1.a.c(e10, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e10);
                }
            } catch (Exception e11) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(org.bouncycastle.asn1.a.c(e12, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e12);
            }
        }
        this.lastModifiedDate = date;
    }
