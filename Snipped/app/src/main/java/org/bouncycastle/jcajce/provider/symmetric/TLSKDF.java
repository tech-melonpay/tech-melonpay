...
public class TLSKDF {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.v(a.l(a.l(a.l(a.l(sb2, str, "$TLS10", configurableProvider, "SecretKeyFactory.TLS10KDF"), str, "$TLS11", configurableProvider, "SecretKeyFactory.TLS11KDF"), str, "$TLS12withSHA256", configurableProvider, "SecretKeyFactory.TLS12WITHSHA256KDF"), str, "$TLS12withSHA384", configurableProvider, "SecretKeyFactory.TLS12WITHSHA384KDF"), str, "$TLS12withSHA512", configurableProvider, "SecretKeyFactory.TLS12WITHSHA512KDF");
        }
    }
    ...
    public static void hmac_hash(Mac mac, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        while (i < length) {
            ...
            mac.doFinal(bArr5, 0);
            int i9 = macSize * i;
            System.arraycopy(bArr5, 0, bArr3, i9, Math.min(macSize, bArr3.length - i9));
            i++;
            bArr6 = bArr4;
        }
    }
