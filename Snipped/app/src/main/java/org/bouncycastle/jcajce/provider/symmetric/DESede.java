...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.v(sb2, str, "$ECB", configurableProvider, "Cipher.DESEDE");
            ...
            a.v(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DESEDEWRAP");
            configurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_alg_CMS3DESwrap, str + "$Wrap");
            a.v(new StringBuilder(), str, "$RFC3211", configurableProvider, "Cipher.DESEDERFC3211WRAP");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", McElieceCCA2KeyGenParameterSpec.SHA1)) {
                ...
                sb3.append(str);
                a.w(sb3, "$PBEWithSHAAndDES2Key", configurableProvider, "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
            ...
            configurableProvider.addAlgorithm(sb4.toString(), str + "$KeyGenerator3");
            StringBuilder sb5 = new StringBuilder();
            sb5.append(str);
            a.w(a.m(sb5, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDEWRAP", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DESEDE");
            configurableProvider.addAlgorithm("SecretKeyFactory", OIWObjectIdentifiers.desEDE, str + "$KeyFactory");
            a.v(a.l(new StringBuilder(), str, "$CMAC", configurableProvider, "Mac.DESEDECMAC"), str, "$CBCMAC", configurableProvider, "Mac.DESEDEMAC");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC/CFB8", a.k(configurableProvider, "Alg.Alias.Mac.DESEDE", "DESEDEMAC", str, "$DESedeCFB8"));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8");
            a.v(new StringBuilder(), str, "$DESede64", configurableProvider, "Mac.DESEDEMAC64");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC64WITHISO7816-4PADDING", a.k(configurableProvider, "Alg.Alias.Mac.DESEDE64", "DESEDEMAC64", str, "$DESede64with7816d4"));
