...
public class RIPEMD160 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder B10 = a.B(new StringBuilder("Alg.Alias.MessageDigest."), "RIPEMD160", configurableProvider, str, TeleTrusTObjectIdentifiers.ripemd160);
            B10.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD160", B10.toString(), v.n(str, "$KeyGenerator"));
            ...
            sb3.append(str);
            a.w(sb3, "$PBEWithHmac", configurableProvider, "Mac.PBEWITHHMACRIPEMD160");
        }
    }
