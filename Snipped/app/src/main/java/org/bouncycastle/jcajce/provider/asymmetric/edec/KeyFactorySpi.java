...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
            ...
            if (i == 0 || i == encoded[8]) {
                if (encoded[9] == 5 && encoded[10] == 0) {
                    ...
                    try {
                        ...
                        throw new InvalidKeySpecException(a.b(e10, new StringBuilder("attempt to reconstruct key failed: ")));
                    }
                }
                switch (encoded[8]) {
                    case 110:
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) {
        ...
        throw new IOException(a.g("algorithm identifier ", algorithm, " in key not recognized"));
    }
