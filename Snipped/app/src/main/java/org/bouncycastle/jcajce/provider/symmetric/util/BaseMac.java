...
public class BaseMac extends MacSpi implements PBE {
    ...
    public void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec) {
        ...
        if (key instanceof PKCS12Key) {
            try {
                ...
                try {
                    ...
                    makePBEMacParameters = PBE.Util.makePBEMacParameters(secretKey, 2, i, i9, pBEParameterSpec);
        ...
        try {
            ...
            throw new InvalidAlgorithmParameterException(v.l(e10, new StringBuilder("cannot initialize MAC: ")));
        }
    }
    ...
    public void engineUpdate(byte b9) {
        this.macEngine.update(b9);
    }

    public BaseMac(Mac mac, int i, int i9, int i10) {
        this.macEngine = mac;
        this.scheme = i;
        this.pbeHash = i9;
        this.keySize = i10;
    ...
    public void engineUpdate(byte[] bArr, int i, int i9) {
        this.macEngine.update(bArr, i, i9);
    }
}
