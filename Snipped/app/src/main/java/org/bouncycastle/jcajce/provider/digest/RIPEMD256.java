...
public class RIPEMD256 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder B10 = a.B(new StringBuilder("Alg.Alias.MessageDigest."), "RIPEMD256", configurableProvider, str, TeleTrusTObjectIdentifiers.ripemd256);
            B10.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD256", B10.toString(), v.n(str, "$KeyGenerator"));
        }
    }
