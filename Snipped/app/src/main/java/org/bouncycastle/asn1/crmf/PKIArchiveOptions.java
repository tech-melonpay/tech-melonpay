...
public class PKIArchiveOptions extends ASN1Object implements ASN1Choice {
    ...
    public static PKIArchiveOptions getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(a.j(obj, "unknown object: "));
    }
    ...
    private PKIArchiveOptions(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo == 0) {
            ...
            if (tagNo != 1) {
                if (tagNo != 2) {
                    throw new IllegalArgumentException(org.bouncycastle.asn1.a.j(aSN1TaggedObject, new StringBuilder("unknown tag number: ")));
                }
