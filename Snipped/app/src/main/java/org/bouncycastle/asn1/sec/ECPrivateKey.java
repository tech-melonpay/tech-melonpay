...
public class ECPrivateKey extends ASN1Object {
    ...
    private ASN1Object getObjectInTag(int i, int i9) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1Encodable instanceof ASN1TaggedObject) {
                ...
                if (aSN1TaggedObject.hasContextTag(i)) {
                    return i9 < 0 ? aSN1TaggedObject.getExplicitBaseObject().toASN1Primitive() : aSN1TaggedObject.getBaseUniversal(true, i9);
                }
            }
        }
        return null;
