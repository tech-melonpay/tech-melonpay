...
public class DSTU4145NamedCurves {
    ...
    static {
        ...
        while (true) {
            ...
            if (i9 >= aSN1ObjectIdentifierArr.length) {
                return;
            }
            aSN1ObjectIdentifierArr[i9] = new ASN1ObjectIdentifier(oidBase + i9);
            i9++;
        }
    }
