...
public class CertTemplateBuilder {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int i, boolean z10, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z10, i, aSN1Encodable));
        }
    }
