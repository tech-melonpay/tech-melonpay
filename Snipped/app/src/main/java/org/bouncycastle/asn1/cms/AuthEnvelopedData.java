...
public class AuthEnvelopedData extends ASN1Object {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Primitive2 instanceof ASN1TaggedObject) {
            ...
            aSN1Primitive2 = aSN1Sequence.getObjectAt(i9).toASN1Primitive();
            i9 = i + 3;
        ...
        if (aSN1Sequence.size() > i9) {
            this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i9).toASN1Primitive(), false);
        }
    }
