...
public class PBKDF2Params extends ASN1Object {
    ...
    public PBKDF2Params(byte[] bArr, int i, int i9) {
        this(bArr, i, i9, null);
    }

    public PBKDF2Params(byte[] bArr, int i, int i9, AlgorithmIdentifier algorithmIdentifier) {
        this.octStr = new DEROctetString(Arrays.clone(bArr));
        this.iterationCount = new ASN1Integer(i);
        this.keyLength = i9 > 0 ? new ASN1Integer(i9) : null;
