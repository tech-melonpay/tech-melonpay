...
public class ResponseData extends ASN1Object {
    ...
    private static final ASN1Integer f24718V1 = new ASN1Integer(0);
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals((ASN1Primitive) f24718V1)) {
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        int i10 = i + 3;
        this.responses = (ASN1Sequence) aSN1Sequence.getObjectAt(i9);
        if (aSN1Sequence.size() > i10) {
            this.responseExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i10), true);
        }
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, Extensions extensions) {
        this(f24718V1, responderID, aSN1GeneralizedTime, aSN1Sequence, extensions);
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f24718V1, responderID, ASN1GeneralizedTime.getInstance(aSN1GeneralizedTime), aSN1Sequence, Extensions.getInstance(x509Extensions));
    }
}
