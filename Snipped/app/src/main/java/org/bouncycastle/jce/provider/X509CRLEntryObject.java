...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f25164c.equals(((X509CRLEntryObject) obj).f25164c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f25164c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f25164c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f25164c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f25164c.getExtensions() != null;
    }
