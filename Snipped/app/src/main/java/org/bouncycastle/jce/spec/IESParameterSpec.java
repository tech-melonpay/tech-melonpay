...
public class IESParameterSpec implements AlgorithmParameterSpec {
    ...
    public IESParameterSpec(byte[] bArr, byte[] bArr2, int i, int i9, byte[] bArr3) {
        this(bArr, bArr2, i, i9, bArr3, false);
    }

    public IESParameterSpec(byte[] bArr, byte[] bArr2, int i, int i9, byte[] bArr3, boolean z10) {
        if (bArr != null) {
