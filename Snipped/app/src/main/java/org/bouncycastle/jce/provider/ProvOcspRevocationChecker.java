...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private Certificate extractCert() {
        try {
            ...
            throw new CertPathValidatorException(v.l(e10, new StringBuilder("cannot process signing cert: ")), e10, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    public static boolean validatedOcspResponse(BasicOCSPResponse basicOCSPResponse, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, byte[] bArr, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) {
        try {
            ...
            throw new CertPathValidatorException(org.bouncycastle.asn1.a.b(e10, new StringBuilder("OCSP response failure: ")), e10, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        } catch (CertPathValidatorException e11) {
            throw e11;
        } catch (GeneralSecurityException e12) {
            throw new CertPathValidatorException(a.p(e12, new StringBuilder("OCSP response failure: ")), e12, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        }
    }
    ...
    */
    ...
    private CertID createCertID(AlgorithmIdentifier algorithmIdentifier, Certificate certificate, ASN1Integer aSN1Integer) {
        try {
            ...
            throw new CertPathValidatorException(com.google.android.gms.measurement.internal.a.i("problem creating ID: ", e10), e10);
        }
    }
