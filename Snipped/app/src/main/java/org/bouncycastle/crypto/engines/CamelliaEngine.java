...
public class CamelliaEngine implements BlockCipher, StatelessProcessing {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i10 = iArr3[i9 & 255];
        int[] iArr4 = SBOX3_3033;
        int i11 = i10 ^ iArr4[(i9 >>> 8) & 255];
        int[] iArr5 = SBOX2_0222;
        int i12 = i11 ^ iArr5[(i9 >>> 16) & 255];
        int[] iArr6 = SBOX1_1110;
        int i13 = iArr6[(i9 >>> 24) & 255] ^ i12;
        int i14 = iArr[1] ^ iArr2[i + 1];
        int i15 = (iArr5[(i14 >>> 24) & 255] ^ ((iArr6[i14 & 255] ^ iArr3[(i14 >>> 8) & 255]) ^ iArr4[(i14 >>> 16) & 255])) ^ i13;
        iArr[2] = iArr[2] ^ i15;
        int rightRotate = (rightRotate(i13, 8) ^ i15) ^ iArr[3];
        iArr[3] = rightRotate;
        int i16 = iArr[2] ^ iArr2[i + 2];
        int i17 = iArr6[(i16 >>> 24) & 255] ^ ((iArr3[i16 & 255] ^ iArr4[(i16 >>> 8) & 255]) ^ iArr5[(i16 >>> 16) & 255]);
        int i18 = iArr2[i + 3] ^ rightRotate;
        int i19 = (iArr5[(i18 >>> 24) & 255] ^ ((iArr6[i18 & 255] ^ iArr3[(i18 >>> 8) & 255]) ^ iArr4[(i18 >>> 16) & 255])) ^ i17;
        iArr[0] = iArr[0] ^ i19;
        iArr[1] = (i19 ^ rightRotate(i17, 8)) ^ iArr[1];
    }
