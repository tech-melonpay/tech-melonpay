...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    private int f24871H0;

    /* renamed from: H1, reason: collision with root package name */
    private int f24872H1;

    /* renamed from: H2, reason: collision with root package name */
    private int f24873H2;

    /* renamed from: H3, reason: collision with root package name */
    private int f24874H3;

    /* renamed from: H4, reason: collision with root package name */
    private int f24875H4;

    /* renamed from: H5, reason: collision with root package name */
    private int f24876H5;

    /* renamed from: H6, reason: collision with root package name */
    private int f24877H6;

    /* renamed from: H7, reason: collision with root package name */
    private int f24878H7;

    /* renamed from: H8, reason: collision with root package name */
    private int f24879H8;

    /* renamed from: H9, reason: collision with root package name */
    private int f24880H9;
    private int[] X;
    private int xOff;
    ...
    private void doCopy(RIPEMD320Digest rIPEMD320Digest) {
        ...
        this.f24871H0 = rIPEMD320Digest.f24871H0;
        this.f24872H1 = rIPEMD320Digest.f24872H1;
        this.f24873H2 = rIPEMD320Digest.f24873H2;
        this.f24874H3 = rIPEMD320Digest.f24874H3;
        this.f24875H4 = rIPEMD320Digest.f24875H4;
        this.f24876H5 = rIPEMD320Digest.f24876H5;
        this.f24877H6 = rIPEMD320Digest.f24877H6;
        this.f24878H7 = rIPEMD320Digest.f24878H7;
        this.f24879H8 = rIPEMD320Digest.f24879H8;
        this.f24880H9 = rIPEMD320Digest.f24880H9;
    ...
    private int f5(int i, int i9, int i10) {
        return i ^ (i9 | (~i10));
    }
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        unpackWord(this.f24871H0, bArr, i);
        unpackWord(this.f24872H1, bArr, i + 4);
        unpackWord(this.f24873H2, bArr, i + 8);
        unpackWord(this.f24874H3, bArr, i + 12);
        unpackWord(this.f24875H4, bArr, i + 16);
        unpackWord(this.f24876H5, bArr, i + 20);
        unpackWord(this.f24877H6, bArr, i + 24);
        unpackWord(this.f24878H7, bArr, i + 28);
        unpackWord(this.f24879H8, bArr, i + 32);
        unpackWord(this.f24880H9, bArr, i + 36);
        reset();
        return 40;
    }
    ...
    public void processBlock() {
        int i = this.f24871H0;
        int i9 = this.f24872H1;
        int i10 = this.f24873H2;
        int i11 = this.f24874H3;
        int i12 = this.f24875H4;
        int i13 = this.f24876H5;
        int i14 = this.f24877H6;
        int i15 = this.f24878H7;
        int i16 = this.f24879H8;
        int i17 = this.f24880H9;
        int RL = RL(i + f1(i9, i10, i11) + this.X[0], 11) + i12;
        int RL2 = RL(i10, 10);
        int RL3 = RL(i12 + f1(RL, i9, RL2) + this.X[1], 14) + i11;
        int RL4 = RL(i9, 10);
        int RL5 = RL(i11 + f1(RL3, RL, RL4) + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i13 + f5(i14, i15, i16) + this.X[5] + 1352829926, 8) + i17;
        int RL34 = RL(i15, 10);
        int RL35 = RL(i17 + f5(RL33, i14, RL34) + this.X[14] + 1352829926, 9) + i16;
        int RL36 = RL(i14, 10);
        int RL37 = RL(i16 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
    ...
    public void reset() {
        super.reset();
        this.f24871H0 = 1732584193;
        this.f24872H1 = -271733879;
        this.f24873H2 = -1732584194;
        this.f24874H3 = 271733878;
        this.f24875H4 = -1009589776;
        this.f24876H5 = 1985229328;
        this.f24877H6 = -19088744;
        this.f24878H7 = -1985229329;
        this.f24879H8 = 19088743;
        this.f24880H9 = 1009589775;
        this.xOff = 0;
        int i = 0;
        while (true) {
            int[] iArr = this.X;
