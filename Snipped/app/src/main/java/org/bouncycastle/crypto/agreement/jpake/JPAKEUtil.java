...
public class JPAKEUtil {
    ...
    public static void validateNotNull(Object obj, String str) {
        if (obj == null) {
            throw new NullPointerException(v.n(str, " must not be null"));
        }
    }

    public static void validateParticipantIdsDiffer(String str, String str2) {
        if (str.equals(str2)) {
            throw new CryptoException(n.a("Both participants are using the same participantId (", str, "). This is not allowed. Each participant must use a unique participantId."));
        }
    }

    public static void validateParticipantIdsEqual(String str, String str2) {
        if (!str.equals(str2)) {
            throw new CryptoException(b.l("Received payload from incorrect partner (", str2, "). Expected to receive payload from ", str, "."));
        }
    }
