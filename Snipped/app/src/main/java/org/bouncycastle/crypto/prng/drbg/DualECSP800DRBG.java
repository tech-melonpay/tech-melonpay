...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    private byte[] pad8(byte[] bArr, int i) {
        ...
        while (length >= 0) {
            ...
            bArr[length] = (byte) ((i11 >> (8 - i10)) | (i12 << i10));
            length--;
            i11 = i12;
        }
        return bArr;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z10) {
        ...
        for (int i9 = 0; i9 < length2; i9++) {
            ...
            int i10 = this._outlen;
            if (length3 > i10) {
                System.arraycopy(byteArray, byteArray.length - i10, bArr, i, i10);
            } else {
                System.arraycopy(byteArray, 0, bArr, (i10 - byteArray.length) + i, byteArray.length);
            }
            i += this._outlen;
            this._reseedCounter++;
        }
        if (i < bArr.length) {
            ...
            if (length5 > i11) {
                System.arraycopy(byteArray2, byteArray2.length - i11, bArr, i, length4);
            } else {
                System.arraycopy(byteArray2, 0, bArr, (i11 - byteArray2.length) + i, length4);
            }
            this._reseedCounter++;
        }
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r2, org.bouncycastle.crypto.Digest r3, int r4, org.bouncycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        ...
        L92:
            ...
            java.lang.String r3 = s3.b.i(r3, r4, r5)
            r2.<init>(r3)
            throw r2
        La0:
            java.lang.IllegalArgumentException r2 = new java.lang.IllegalArgumentException
