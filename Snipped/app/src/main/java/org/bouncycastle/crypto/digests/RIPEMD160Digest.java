...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    private int f24858H0;

    /* renamed from: H1, reason: collision with root package name */
    private int f24859H1;

    /* renamed from: H2, reason: collision with root package name */
    private int f24860H2;

    /* renamed from: H3, reason: collision with root package name */
    private int f24861H3;

    /* renamed from: H4, reason: collision with root package name */
    private int f24862H4;
    private int[] X;
    private int xOff;
    ...
    private void copyIn(RIPEMD160Digest rIPEMD160Digest) {
        ...
        this.f24858H0 = rIPEMD160Digest.f24858H0;
        this.f24859H1 = rIPEMD160Digest.f24859H1;
        this.f24860H2 = rIPEMD160Digest.f24860H2;
        this.f24861H3 = rIPEMD160Digest.f24861H3;
        this.f24862H4 = rIPEMD160Digest.f24862H4;
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        unpackWord(this.f24858H0, bArr, i);
        unpackWord(this.f24859H1, bArr, i + 4);
        unpackWord(this.f24860H2, bArr, i + 8);
        unpackWord(this.f24861H3, bArr, i + 12);
        unpackWord(this.f24862H4, bArr, i + 16);
        reset();
        return 20;
    }
    ...
    public void processBlock() {
        int i = this.f24858H0;
        int i9 = this.f24859H1;
        int i10 = this.f24860H2;
        int i11 = this.f24861H3;
        int i12 = this.f24862H4;
        int RL = RL(f1(i9, i10, i11) + i + this.X[0], 11) + i12;
        int RL2 = RL(i10, 10);
        int RL3 = RL(f1(RL, i9, RL2) + i12 + this.X[1], 14) + i11;
        int RL4 = RL(i9, 10);
        int RL5 = RL(f1(RL3, RL, RL4) + i11 + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i + f5(i9, i10, i11) + this.X[5] + 1352829926, 8) + i12;
        int RL34 = RL(i10, 10);
        int RL35 = RL(i12 + f5(RL33, i9, RL34) + this.X[14] + 1352829926, 9) + i11;
        int RL36 = RL(i9, 10);
        int RL37 = RL(i11 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
        ...
        int RL320 = RL285 + this.f24859H1 + RL(RL315, 10);
        this.f24859H1 = this.f24860H2 + RL288 + RL318;
        this.f24860H2 = this.f24861H3 + RL286 + RL316;
        this.f24861H3 = this.f24862H4 + RL284 + RL319;
        this.f24862H4 = this.f24858H0 + RL287 + RL317;
        this.f24858H0 = RL320;
        this.xOff = 0;
        int i13 = 0;
        while (true) {
    ...
    public void reset() {
        super.reset();
        this.f24858H0 = 1732584193;
        this.f24859H1 = -271733879;
        this.f24860H2 = -1732584194;
        this.f24861H3 = 271733878;
        this.f24862H4 = -1009589776;
        this.xOff = 0;
        int i = 0;
        while (true) {
            int[] iArr = this.X;
