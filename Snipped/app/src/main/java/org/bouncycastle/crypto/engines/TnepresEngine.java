...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i9) {
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToBigEndian(iArr[3] ^ this.wKey[3], bArr2, i9);
        Pack.intToBigEndian(iArr[2] ^ this.wKey[2], bArr2, i9 + 4);
        Pack.intToBigEndian(iArr[1] ^ this.wKey[1], bArr2, i9 + 8);
        Pack.intToBigEndian(iArr[0] ^ this.wKey[0], bArr2, i9 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i9) {
        int[] iArr = {r0, Pack.bigEndianToInt(bArr, i + 8), Pack.bigEndianToInt(bArr, i + 4), Pack.bigEndianToInt(bArr, i)};
        ...
        Pack.intToBigEndian(this.wKey[131] ^ iArr[3], bArr2, i9);
        Pack.intToBigEndian(this.wKey[130] ^ iArr[2], bArr2, i9 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ iArr[1], bArr2, i9 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ iArr[0], bArr2, i9 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) {
        ...
        for (int i10 = 8; i10 < 16; i10++) {
            int i11 = i10 - 8;
            iArr[i10] = SerpentEngineBase.rotateLeft(((-1640531527) ^ (((iArr[i11] ^ iArr[i10 - 5]) ^ iArr[i10 - 3]) ^ iArr[i10 - 1])) ^ i11, 11);
        }
        System.arraycopy(iArr, 8, iArr2, 0, 8);
        for (int i12 = 8; i12 < 132; i12++) {
            iArr2[i12] = SerpentEngineBase.rotateLeft(((((iArr2[i12 - 8] ^ iArr2[i12 - 5]) ^ iArr2[i12 - 3]) ^ iArr2[i12 - 1]) ^ (-1640531527)) ^ i12, 11);
        }
        int[] iArr3 = new int[4];
