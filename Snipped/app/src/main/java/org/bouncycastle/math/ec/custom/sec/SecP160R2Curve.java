...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f25225q = SecP160R2FieldElement.f25227Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f25187a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f25188b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
