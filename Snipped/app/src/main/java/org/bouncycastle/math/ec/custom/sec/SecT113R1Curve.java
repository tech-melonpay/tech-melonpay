...
public class SecT113R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT113R1Curve() {
        ...
        this.f25187a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("003088250CA6E7C7FE649CE85820F7")));
        this.f25188b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00E8BEE4D3E2260744188BE0E9C723")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i9) {
        final long[] jArr = new long[i9 * 4];
        int i10 = 0;
        for (int i11 = 0; i11 < i9; i11++) {
            ECPoint eCPoint = eCPointArr[i + i11];
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawXCoord()).f25271x, 0, jArr, i10);
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawYCoord()).f25271x, 0, jArr, i10 + 2);
            i10 += 4;
        }
            ...
            public ECPoint lookup(int i12) {
                ...
                for (int i14 = 0; i14 < i9; i14++) {
                    ...
                    for (int i15 = 0; i15 < 2; i15++) {
                        ...
                        create642[i15] = create642[i15] ^ (jArr2[(i13 + 2) + i15] & j10);
                    }
                    i13 += 4;
                }
