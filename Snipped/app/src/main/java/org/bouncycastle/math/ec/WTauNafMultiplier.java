...
public class WTauNafMultiplier extends AbstractECMultiplier {
    ...
    private static ECPoint.AbstractF2m multiplyFromWTnaf(final ECPoint.AbstractF2m abstractF2m, byte[] bArr) {
        ...
        for (int length = bArr.length - 1; length >= 0; length--) {
            ...
            byte b9 = bArr[length];
            if (b9 != 0) {
                abstractF2m3 = (ECPoint.AbstractF2m) abstractF2m3.tauPow(i9).add(b9 > 0 ? preComp[b9 >>> 1] : abstractF2mArr[(-b9) >>> 1]);
                i9 = 0;
            }
        }
        return i9 > 0 ? abstractF2m3.tauPow(i9) : abstractF2m3;
    }

    private ECPoint.AbstractF2m multiplyWTnaf(ECPoint.AbstractF2m abstractF2m, ZTauElement zTauElement, byte b9, byte b10) {
        return multiplyFromWTnaf(abstractF2m, Tnaf.tauAdicWNaf(b10, zTauElement, (byte) 4, BigInteger.valueOf(16L), Tnaf.getTw(b10, 4), b9 == 0 ? Tnaf.alpha0 : Tnaf.alpha1));
    }
