...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement t3 = a.t(eCFieldElement2, multiply, square);
        if (t3.isZero()) {
            return new SecT233R1Point(curve, t3, curve.getB().sqrt());
        }
        ...
        return new SecT233R1Point(curve, square2, eCFieldElement.squarePlusProduct(t3, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
