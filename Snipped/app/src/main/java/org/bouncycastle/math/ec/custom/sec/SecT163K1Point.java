...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement t3 = a.t(eCFieldElement2, multiply, eCFieldElement3);
        if (t3.isZero()) {
            return new SecT163K1Point(curve, t3, curve.getB());
        }
        ECFieldElement square = t3.square();
        ECFieldElement multiply2 = isOne ? t3 : t3.multiply(eCFieldElement3);
        ECFieldElement square2 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, square, square2.add(t3).add(eCFieldElement3).multiply(square2).add(square), new ECFieldElement[]{multiply2});
    }
