...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f25203q = Curve25519FieldElement.f25207Q;
    ...
    public Curve25519() {
        ...
        this.f25187a = fromBigInteger(C_a);
        this.f25188b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i9) {
        ...
        for (int i11 = 0; i11 < i9; i11++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f25208x, 0, iArr, i10);
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f25208x, 0, iArr, i10 + 8);
            i10 += 16;
        }
