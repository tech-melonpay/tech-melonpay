...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f25199x, this.f25200y.negate(), this.zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] create = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f25228x, create);
        int[] create2 = Nat160.create();
        SecP160R2Field.square(create, create2);
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f25228x, create3);
        SecP160R2Field.reduce32(Nat160.addBothTo(create3, create3, create3), create3);
        SecP160R2Field.multiply(create, secP160R2FieldElement2.f25228x, create);
        ...
        SecP160R2Field.square(create3, secP160R2FieldElement4.f25228x);
        int[] iArr = secP160R2FieldElement4.f25228x;
        ...
        SecP160R2Field.subtract(create, secP160R2FieldElement4.f25228x, secP160R2FieldElement5.f25228x);
        int[] iArr3 = secP160R2FieldElement5.f25228x;
        ...
        if (!secP160R2FieldElement3.isOne()) {
            int[] iArr5 = secP160R2FieldElement6.f25228x;
            SecP160R2Field.multiply(iArr5, secP160R2FieldElement3.f25228x, iArr5);
        }
