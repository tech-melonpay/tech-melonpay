...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f25256q = SecP256R1FieldElement.f25260Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f25187a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f25188b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i9) {
        ...
        for (int i11 = 0; i11 < i9; i11++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f25261x, 0, iArr, i10);
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f25261x, 0, iArr, i10 + 8);
            i10 += 16;
        }
