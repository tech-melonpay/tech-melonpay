...
public class SecT193R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (t3.isZero()) {
            return new SecT193R2Point(curve, t3, curve.getB().sqrt());
        }
        ...
        return new SecT193R2Point(curve, square2, eCFieldElement.squarePlusProduct(t3, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
