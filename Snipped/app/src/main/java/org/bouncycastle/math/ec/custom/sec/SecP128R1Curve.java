...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f25214q = SecP128R1FieldElement.f25217Q;
    ...
    public SecP128R1Curve() {
        ...
        this.f25187a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f25188b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i9) {
        final int[] iArr = new int[i9 * 8];
        int i10 = 0;
        for (int i11 = 0; i11 < i9; i11++) {
            ECPoint eCPoint = eCPointArr[i + i11];
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawXCoord()).f25218x, 0, iArr, i10);
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawYCoord()).f25218x, 0, iArr, i10 + 4);
            i10 += 8;
        }
            ...
            public ECPoint lookup(int i12) {
                ...
                for (int i14 = 0; i14 < i9; i14++) {
                    ...
                    for (int i16 = 0; i16 < 4; i16++) {
                        ...
                        create2[i16] = create2[i16] ^ (iArr2[(i13 + 4) + i16] & i15);
                    }
                    i13 += 8;
                }
