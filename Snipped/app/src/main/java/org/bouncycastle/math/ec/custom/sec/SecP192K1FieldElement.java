...
public class SecP192K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public static final BigInteger f25232Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFEE37"));

    /* renamed from: x, reason: collision with root package name */
    protected int[] f25233x;

    public SecP192K1FieldElement() {
        this.f25233x = Nat192.create();
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.add(this.f25233x, ((SecP192K1FieldElement) eCFieldElement).f25233x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat192.create();
        SecP192K1Field.addOne(this.f25233x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.inv(((SecP192K1FieldElement) eCFieldElement).f25233x, create);
        SecP192K1Field.multiply(create, this.f25233x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP192K1FieldElement) {
            return Nat192.eq(this.f25233x, ((SecP192K1FieldElement) obj).f25233x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f25232Q.bitLength();
    }

    public int hashCode() {
        return f25232Q.hashCode() ^ Arrays.hashCode(this.f25233x, 0, 6);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat192.create();
        SecP192K1Field.inv(this.f25233x, create);
        return new SecP192K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat192.isOne(this.f25233x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat192.isZero(this.f25233x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.multiply(this.f25233x, ((SecP192K1FieldElement) eCFieldElement).f25233x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat192.create();
        SecP192K1Field.negate(this.f25233x, create);
        return new SecP192K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f25233x;
    ...
    public ECFieldElement square() {
        int[] create = Nat192.create();
        SecP192K1Field.square(this.f25233x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.subtract(this.f25233x, ((SecP192K1FieldElement) eCFieldElement).f25233x, create);
        return new SecP192K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat192.getBit(this.f25233x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f25233x);
    }

    public SecP192K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f25232Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP192K1FieldElement");
        }
        this.f25233x = SecP192K1Field.fromBigInteger(bigInteger);
    }
