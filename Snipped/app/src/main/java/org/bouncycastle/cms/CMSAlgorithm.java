...
public class CMSAlgorithm {
    ...
    public static final ASN1ObjectIdentifier IDEA_CBC = a.s(CMSEnvelopedGenerator.IDEA_CBC);
    public static final ASN1ObjectIdentifier CAST5_CBC = a.s(CMSEnvelopedGenerator.CAST5_CBC);
