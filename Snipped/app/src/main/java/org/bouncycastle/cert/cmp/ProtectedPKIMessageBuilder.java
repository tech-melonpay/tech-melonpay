...
public class ProtectedPKIMessageBuilder {
    ...
    public ProtectedPKIMessage build(ContentSigner contentSigner) {
        ...
        try {
            ...
            throw new CMPException(a.b(e10, new StringBuilder("unable to encode signature input: ")), e10);
        }
    }
    ...
    public ProtectedPKIMessage build(MacCalculator macCalculator) {
        ...
        try {
            ...
            throw new CMPException(a.b(e10, new StringBuilder("unable to encode MAC input: ")), e10);
        }
    }
}
