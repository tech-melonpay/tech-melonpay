    ...
    public static SecurityInfo getInstance(ASN1Primitive aSN1Primitive) {
        try {
            ...
            if (ActiveAuthenticationInfo.checkRequiredIdentifier(id)) {
                ...
                return aSN1Primitive3 == null ? new ActiveAuthenticationInfo(id, intValue, null) : new ActiveAuthenticationInfo(id, intValue, ((ASN1ObjectIdentifier) aSN1Primitive3).getId());
            }
            ...
            if (ChipAuthenticationInfo.checkRequiredIdentifier(id)) {
                ...
                return aSN1Primitive3 == null ? new ChipAuthenticationInfo(id, intValue2) : new ChipAuthenticationInfo(id, intValue2, ((ASN1Integer) aSN1Primitive3).getValue());
            }
            if (TerminalAuthenticationInfo.checkRequiredIdentifier(id)) {
                int intValue3 = ((ASN1Integer) aSN1Primitive2).getValue().intValue();
                return aSN1Primitive3 == null ? new TerminalAuthenticationInfo(id, intValue3) : new TerminalAuthenticationInfo(id, intValue3, (ASN1Sequence) aSN1Primitive3);
            }
            ...
            if (PACEDomainParameterInfo.checkRequiredIdentifier(id)) {
                ...
                return aSN1Primitive3 != null ? new PACEDomainParameterInfo(id, algorithmIdentifier, ((ASN1Integer) aSN1Primitive3).getValue()) : new PACEDomainParameterInfo(id, algorithmIdentifier);
            }
