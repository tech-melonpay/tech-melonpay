...
public class C1012n extends ImageButton {
    private final C1002d mBackgroundTintHelper;
    private boolean mHasLevel;
    private final C1013o mImageHelper;

    public C1012n(Context context, AttributeSet attributeSet) {
    ...
    public C1012n(Context context, AttributeSet attributeSet, int i) {
