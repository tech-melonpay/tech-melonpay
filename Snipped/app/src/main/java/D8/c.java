...
/* compiled from: NewPaymentEuropeanFragmentArgs.kt */
/* loaded from: classes2.dex */
public final class c implements e {

    /* renamed from: a, reason: collision with root package name */
    public final PaymentUI f20472a;
    ...
    public final boolean equals(Object obj) {
        ...
        c cVar = (c) obj;
        return f.b(this.f20472a, cVar.f20472a) && this.f20473b == cVar.f20473b && this.f20474c == cVar.f20474c;
    }

    public final int hashCode() {
        PaymentUI paymentUI = this.f20472a;
        return Integer.hashCode(this.f20474c) + v.d((paymentUI == null ? 0 : paymentUI.hashCode()) * 31, 31, this.f20473b);
    }

    public final String toString() {
        StringBuilder sb2 = new StringBuilder("NewPaymentEuropeanFragmentArgs(payment=");
        sb2.append(this.f20472a);
        sb2.append(", isTemplate=");
        sb2.append(this.f20473b);
        sb2.append(", backstackId=");
        return s3.b.m(sb2, this.f20474c, ")");
    }
}
