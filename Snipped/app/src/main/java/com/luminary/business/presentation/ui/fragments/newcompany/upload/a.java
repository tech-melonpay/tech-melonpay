...
/* compiled from: UploadDocumentsFragmentArgs.kt */
/* loaded from: classes2.dex */
public final class a implements e {

    /* renamed from: a, reason: collision with root package name */
    public final CompanyDetailsUI f12739a;

    /* compiled from: UploadDocumentsFragmentArgs.kt */
    /* renamed from: com.luminary.business.presentation.ui.fragments.newcompany.upload.a$a, reason: collision with other inner class name */
    public static final class C0137a {
        public static a a(Bundle bundle) {
            if (!v.y(bundle, a.class, "companyDetails")) {
            ...
            if (companyDetailsUI != null) {
                return new a(companyDetailsUI);
            }
            throw new IllegalArgumentException("Argument \"companyDetails\" is marked as non-null but was passed a null value.");
        }
    }

    public a(CompanyDetailsUI companyDetailsUI) {
        this.f12739a = companyDetailsUI;
    }

    public static final a fromBundle(Bundle bundle) {
        return C0137a.a(bundle);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof a) && f.b(this.f12739a, ((a) obj).f12739a);
    }
    ...
    public final String toString() {
        return "UploadDocumentsFragmentArgs(companyDetails=" + this.f12739a + ")";
    }
}
