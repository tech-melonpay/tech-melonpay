...
public final class d0 {
    ...
    public static final class a implements InterfaceC1162A<d0> {
        ...
        public static final /* synthetic */ pa.f f13610b;

        static {
            a aVar = new a();
            f13609a = aVar;
            C1165D c1165d = new C1165D("com.sumsub.sentry.SentryId", aVar);
            c1165d.k("uuid", true);
            f13610b = c1165d;
        }

        public String a(InterfaceC1144d interfaceC1144d) {
            return d0.b(interfaceC1144d.o(getDescriptor()).p());
        }
    ...
    public static final class Companion {
        ...
        public final String a(UUID uuid) {
            return C0967l.X(uuid.toString(), "-", "", false);
        }
    ...
    public static boolean a(String str, Object obj) {
        return (obj instanceof d0) && kotlin.jvm.internal.f.b(str, ((d0) obj).b());
    }
