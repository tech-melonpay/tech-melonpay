...
public final class SNSPrimaryButton extends MaterialButton {
    ...
    public /* synthetic */ SNSPrimaryButton(Context context, AttributeSet attributeSet, int i, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i9 & 2) != 0 ? null : attributeSet, (i9 & 4) != 0 ? R.attr.materialButtonStyle : i);
    }

    public SNSPrimaryButton(Context context, AttributeSet attributeSet, int i) {
        ...
        if (a10 != null) {
            ...
            Integer a11 = aVar.a(this, SNSColorElement.PRIMARY_BUTTON_CONTENT);
            Integer a12 = aVar.a(this, SNSColorElement.PRIMARY_BUTTON_CONTENT_DISABLED);
            Integer a13 = aVar.a(this, SNSColorElement.PRIMARY_BUTTON_CONTENT_HIGHLIGHTED);
            ...
            Integer a14 = aVar.a(this, SNSColorElement.PRIMARY_BUTTON_BACKGROUND);
            Integer a15 = aVar.a(this, SNSColorElement.PRIMARY_BUTTON_BACKGROUND_DISABLED);
            Integer a16 = aVar.a(this, SNSColorElement.PRIMARY_BUTTON_BACKGROUND_HIGHLIGHTED);
