...
public final class SNSCheckGroup extends LinearLayout implements com.sumsub.sns.internal.core.widget.a {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        if (!(child instanceof CheckBox) || a11 == null) {
            return;
        }
        ...
        ((CheckBox) child).setButtonTintList(new ColorStateList(iArr, new int[]{intValue, a13 != null ? a13.intValue() : intValue}));
    }
    ...
    public /* synthetic */ SNSCheckGroup(Context context, AttributeSet attributeSet, int i, int i9, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i10 & 2) != 0 ? null : attributeSet, (i10 & 4) != 0 ? R$attr.sns_CheckGroupStyle : i, (i10 & 8) != 0 ? R$style.Widget_SNSCheckGroup : i9);
    }

    public SNSCheckGroup(Context context, AttributeSet attributeSet, int i, int i9) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.SNSCheckGroup, i, i9);
        fVar.o(com.sumsub.sns.internal.core.common.i.a(obtainStyledAttributes, context, R$styleable.SNSCheckGroup_sns_checkBackgroundColor));
        setBackground(fVar);
        ...
        if (a13 != null) {
            fVar.o(new ColorStateList(new int[][]{new int[]{R$attr.sns_stateInit}, new int[]{R$attr.sns_stateRejected}, new int[0]}, new int[]{0, a13.intValue(), 0}));
        }
