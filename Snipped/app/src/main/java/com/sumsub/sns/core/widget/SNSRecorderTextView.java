...
public final class SNSRecorderTextView extends SNSTextView {
    ...
    public /* synthetic */ SNSRecorderTextView(Context context, AttributeSet attributeSet, int i, int i9, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i10 & 2) != 0 ? null : attributeSet, (i10 & 4) != 0 ? R$attr.sns_RecorderTextViewStyle : i, (i10 & 8) != 0 ? R$style.Widget_SNSTextView_Recorder : i9);
    }

    public SNSRecorderTextView(Context context, AttributeSet attributeSet, int i, int i9) {
        super(context, attributeSet, i, i9, null, null, 48, null);
    }
}
