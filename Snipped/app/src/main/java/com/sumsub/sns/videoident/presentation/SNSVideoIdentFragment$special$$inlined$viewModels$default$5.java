...
public final class SNSVideoIdentFragment$special$$inlined$viewModels$default$5 extends Lambda implements InterfaceC0635a<T> {
    final /* synthetic */ f $owner$delegate;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SNSVideoIdentFragment$special$$inlined$viewModels$default$5(Fragment fragment, f fVar) {
        super(0);
