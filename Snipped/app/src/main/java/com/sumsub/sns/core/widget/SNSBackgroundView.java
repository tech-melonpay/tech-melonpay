...
public class SNSBackgroundView extends FrameLayout {
    ...
    public /* synthetic */ SNSBackgroundView(Context context, AttributeSet attributeSet, int i, int i9, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i10 & 2) != 0 ? null : attributeSet, (i10 & 4) != 0 ? R$attr.sns_BackgroundViewStyle : i, (i10 & 8) != 0 ? R$style.Widget_SNSBackgroundView : i9);
    }

    public SNSBackgroundView(Context context, AttributeSet attributeSet, int i, int i9) {
        super(context, attributeSet, i);
        Integer a10;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.SNSBackgroundView, i, i9);
        int i10 = R$styleable.SNSBackgroundView_android_background;
