...
public class MessagingAnalytics {
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, f fVar) {
        ...
        try {
            C0894m a10 = fVar.a(Constants.FirelogAnalytics.FCM_LOG_SOURCE, new b("proto"), new d() { // from class: com.google.firebase.messaging.MessagingAnalytics$$ExternalSyntheticLambda0
                @Override // g2.d
            ...
            a10.a(new C0759a(newBuilder.build(), Priority.f8902b));
    ...
    public static void logToScion(String str, Bundle bundle) {
        try {
            ...
            if (Log.isLoggable(Constants.TAG, 3)) {
                ...
                Log.d(Constants.TAG, s3.b.o(new StringBuilder(obj.length() + str.length() + 37), "Logging to scion event=", str, " scionPayload=", obj));
            }
