...
final class TopicOperation {
    ...
    private TopicOperation(String str, String str2) {
        ...
        this.operation = str;
        this.serializedString = b.n(new StringBuilder(String.valueOf(str).length() + 1 + String.valueOf(str2).length()), str, "!", str2);
    }
    ...
    private static String normalizeTopicOrThrow(String str, String str2) {
        ...
        if (str == null || !TOPIC_NAME_REGEXP.matcher(str).matches()) {
            throw new IllegalArgumentException(n.a("Invalid topic name: ", str, " does not match the allowed format [a-zA-Z0-9-_.~%]{1,900}."));
        }
        return str;
    }
