...
final class zzbz implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzg = a.B(6, FieldDescriptor.builder("detectedBarcodeFormats"));
    private static final FieldDescriptor zzh = a.B(7, FieldDescriptor.builder("detectedBarcodeValueTypes"));
