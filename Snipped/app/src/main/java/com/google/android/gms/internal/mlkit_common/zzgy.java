...
final class zzgy implements ObjectEncoder {
    ...
    private static final FieldDescriptor zze = a.c(4, FieldDescriptor.builder("documentPresenceConfidence"));
    private static final FieldDescriptor zzf = a.c(5, FieldDescriptor.builder("documentCornerConfidence"));
