...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) @InstallState int i9, @SafeParcelable.Param(id = 3) Long l10, @SafeParcelable.Param(id = 4) Long l11, @SafeParcelable.Param(id = 5) int i10) {
        this.zaa = i;
        this.zab = i9;
        this.zac = l10;
        this.zad = l11;
