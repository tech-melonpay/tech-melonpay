...
final class zzmq {
    ...
    public static /* synthetic */ int zza(byte[] bArr, int i, int i9) {
        byte b9 = bArr[i - 1];
        int i10 = i9 - i;
        if (i10 != 0) {
            if (i10 == 1) {
    ...
    public static String zzd(byte[] bArr, int i, int i9) {
        ...
        while (i < i10) {
            ...
            if (zzmm.zzd(b10)) {
                ...
                i += 2;
                zzmm.zzb(b10, bArr[i13], cArr, i12);
                i12++;
            } else if (b10 < -16) {
                if (i13 >= i10 - 1) {
                    throw zzkh.zzc();
                ...
                int i14 = i + 2;
                i += 3;
                zzmm.zzc(b10, bArr[i13], bArr[i14], cArr, i12);
                i12++;
            } else {
                if (i13 >= i10 - 2) {
                    throw zzkh.zzc();
                ...
                int i16 = i + 3;
                i += 4;
                zzmm.zza(b10, bArr[i13], bArr[i15], bArr[i16], cArr, i12);
                i12 += 2;
            }
        }
