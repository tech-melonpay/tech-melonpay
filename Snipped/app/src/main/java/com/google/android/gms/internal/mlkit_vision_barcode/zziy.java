...
final class zziy implements ObjectEncoder {
    ...
    private static final FieldDescriptor zze = a.x(4, FieldDescriptor.builder("documentPresenceConfidence"));
    private static final FieldDescriptor zzf = a.x(5, FieldDescriptor.builder("documentCornerConfidence"));
