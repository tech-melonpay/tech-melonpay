...
final class zzxy {
    ...
    public static void zzD(Object obj, long j10, byte b9) {
        long j11 = (-4) & j10;
        zzxx zzxxVar = zzg;
        int zzj = zzxxVar.zzj(obj, j11);
        int i = ((~((int) j10)) & 3) << 3;
        zzxxVar.zzn(obj, j11, ((255 & b9) << i) | (zzj & (~(255 << i))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b9) {
        ...
        zzxx zzxxVar = zzg;
        int i = (((int) j10) & 3) << 3;
        zzxxVar.zzn(obj, j11, ((255 & b9) << i) | (zzxxVar.zzj(obj, j11) & (~(255 << i))));
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        ...
        logger.logp(level, "com.google.protobuf.UnsafeUtil", "logMissingMethod", a.n(new StringBuilder(valueOf.length() + 71), "platform method missing - proto runtime falling back to safer methods: ", valueOf));
    }
