...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(ActivityC0533g activityC0533g);
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(v.p(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z10) {
                    throw new IllegalStateException(n.a("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
        ...
        public Builder enableAutoManage(ActivityC0533g activityC0533g, int i, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) activityC0533g);
        ...
        public Builder enableAutoManage(ActivityC0533g activityC0533g, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(activityC0533g, 0, onConnectionFailedListener);
            return this;
        }
