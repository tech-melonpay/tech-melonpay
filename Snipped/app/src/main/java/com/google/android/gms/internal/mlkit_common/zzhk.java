...
final class zzhk implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzc = a.c(2, FieldDescriptor.builder("detectorOptions"));
    private static final FieldDescriptor zzd = a.c(3, FieldDescriptor.builder("imageInfo"));
    private static final FieldDescriptor zze = a.c(4, FieldDescriptor.builder("detectedFaces"));
