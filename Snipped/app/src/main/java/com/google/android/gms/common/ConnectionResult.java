...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i9, @SafeParcelable.Param(id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(id = 4) String str) {
        this.zza = i;
        this.zzb = i9;
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return b.i("UNKNOWN_ERROR_CODE(", i, ")");
                }
        }
    }
