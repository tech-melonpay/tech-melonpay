...
final class zzhx implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzd = a.c(3, FieldDescriptor.builder("identifyLanguageResult"));
    private static final FieldDescriptor zze = a.c(4, FieldDescriptor.builder("identifyPossibleLanguagesResult"));
