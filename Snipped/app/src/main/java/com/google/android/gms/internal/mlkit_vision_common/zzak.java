...
final class zzak implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.B(1, FieldDescriptor.builder("key"));
    ...
    private final zzak zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) {
    ...
    private final zzak zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) {
    ...
    public final zzak zzd(FieldDescriptor fieldDescriptor, int i, boolean z10) {
        if (z10 && i == 0) {
            return this;
        }
    ...
    public final zzak zze(FieldDescriptor fieldDescriptor, long j10, boolean z10) {
        if (z10 && j10 == 0) {
            return this;
        }
        zzai zzj = zzj(fieldDescriptor);
