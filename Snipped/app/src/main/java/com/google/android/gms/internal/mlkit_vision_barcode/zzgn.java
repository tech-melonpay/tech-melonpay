...
final class zzgn implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzd = a.x(3, FieldDescriptor.builder("modelInitializationMs"));
    private static final FieldDescriptor zze = a.x(4, FieldDescriptor.builder("confidenceThreshold"));
