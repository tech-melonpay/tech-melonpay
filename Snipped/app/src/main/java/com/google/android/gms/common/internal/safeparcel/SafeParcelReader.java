...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(a.g(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i < dataPosition || i > parcel.dataSize()) {
            throw new ParseException(v.k(dataPosition, i, "Size read is invalid start=", " end="), parcel);
        }
        return i;
    }

    private static void zza(Parcel parcel, int i, int i9, int i10) {
        if (i9 == i10) {
            return;
        }
        throw new ParseException(androidx.camera.core.impl.utils.a.n(androidx.camera.core.impl.utils.a.q(i10, i9, "Expected size ", " got ", " (0x"), Integer.toHexString(i9), ")"), parcel);
    }

    private static void zzb(Parcel parcel, int i, int i9) {
        int readSize = readSize(parcel, i);
        if (readSize == i9) {
            return;
        }
        throw new ParseException(androidx.camera.core.impl.utils.a.n(androidx.camera.core.impl.utils.a.q(i9, readSize, "Expected size ", " got ", " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
