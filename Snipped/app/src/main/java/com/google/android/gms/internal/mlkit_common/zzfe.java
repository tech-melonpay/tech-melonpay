...
final class zzfe implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzb = a.c(1, FieldDescriptor.builder("supportedFormats"));
    ...
    private static final FieldDescriptor zze = a.c(4, FieldDescriptor.builder("allowManualInput"));
