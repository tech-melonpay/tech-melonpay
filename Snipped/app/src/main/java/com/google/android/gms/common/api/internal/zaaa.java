...
final class zaaa implements zaca {
    ...
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i, boolean z10) {
        zaaaVar.zab.zac(i, z10);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
    ...
    public final void zas(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        printWriter.append((CharSequence) str).append("authClient").println(p.f15541a);
        this.zae.zas(String.valueOf(str).concat("  "), fileDescriptor, printWriter, strArr);
        printWriter.append((CharSequence) str).append("anonClient").println(p.f15541a);
