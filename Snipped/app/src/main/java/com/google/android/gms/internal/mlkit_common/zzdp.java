...
final class zzdp implements ObjectEncoder {
    ...
    private static final FieldDescriptor zze = a.c(4, FieldDescriptor.builder("options"));
    private static final FieldDescriptor zzf = a.c(5, FieldDescriptor.builder("documentPresenceConfidence"));
    private static final FieldDescriptor zzg = a.c(6, FieldDescriptor.builder("documentCornerConfidence"));
