...
final class zzgr implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzd = a.c(3, FieldDescriptor.builder("detectedBarcodeFormats"));
    private static final FieldDescriptor zze = a.c(4, FieldDescriptor.builder("detectedBarcodeValueTypes"));
