...
final class zzjx implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzd = a.x(3, FieldDescriptor.builder("identifyLanguageResult"));
    private static final FieldDescriptor zze = a.x(4, FieldDescriptor.builder("identifyPossibleLanguagesResult"));
