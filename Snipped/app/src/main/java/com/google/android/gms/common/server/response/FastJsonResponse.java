...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(a.g(i, "Unsupported type for conversion: "));
            case 4:
                if (zae != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @KeepForSdk
        public static Field withConverter(String str, int i, FieldConverter<?, ?> fieldConverter, boolean z10) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, z10, 0, false, str, i, null, fieldConverter);
        }
        ...
        public Field(int i, boolean z10, int i9, boolean z11, String str, int i10, Class cls, FieldConverter fieldConverter) {
            this.zai = 1;
            this.zaa = i;
            this.zab = z10;
            this.zac = i9;
