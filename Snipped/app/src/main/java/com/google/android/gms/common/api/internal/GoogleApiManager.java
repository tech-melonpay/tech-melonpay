...
public class GoogleApiManager implements Handler.Callback {
    ...
    public static Status zaH(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, s3.b.k("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", a.l("Could not find API instance ", i9, " while trying to fail enqueued calls.").toString(), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    zabqVar.zaD(new Status(17, s3.b.k("Error resolution was canceled by the user, original error message: ", this.zal.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                } else {
                    apiKey = zabqVar.zad;
    ...
    public final void zay(MethodInvocation methodInvocation, int i, long j10, int i9) {
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(18, new zace(methodInvocation, i, j10, i9)));
    }
