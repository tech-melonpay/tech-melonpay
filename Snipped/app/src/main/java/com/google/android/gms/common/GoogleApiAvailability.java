...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i9) {
        return getErrorDialog(activity, i, i9, (DialogInterface.OnCancelListener) null);
    }
    ...
    public PendingIntent getErrorResolutionPendingIntent(Context context, int i, int i9) {
        return super.getErrorResolutionPendingIntent(context, i, i9);
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, int i9) {
        return showErrorDialogFragment(activity, i, i9, null);
    }
    ...
    public final void zad(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        try {
            if (activity instanceof ActivityC0533g) {
                SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((ActivityC0533g) activity).getSupportFragmentManager(), str);
                return;
            }
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        String str2;
        int i10;
        Log.w("GoogleApiAvailability", b.i("GMS core API Availability. ConnectionResult=", i, ", tag=null"), new IllegalArgumentException());
        if (i == 18) {
            zaf(context);
            return;
        }
        ...
        rVar.f22354x = true;
        rVar.c(16, true);
        rVar.f22336e = r.b(zaf);
        p pVar = new p();
        pVar.f22301e = r.b(zae);
        rVar.e(pVar);
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            rVar.f22328M.icon = context.getApplicationInfo().icon;
            rVar.f22342l = 2;
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                int i11 = com.google.android.gms.base.R.drawable.common_full_open_on_phone;
                i9 = 1;
                rVar.f22333b.add(new m(i11 == 0 ? null : IconCompat.b(null, "", i11), resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent, new Bundle(), null, null, true, 0, true, false, false));
            } else {
                i9 = 1;
                rVar.f22338g = pendingIntent;
            }
        } else {
            i9 = 1;
            rVar.f22328M.icon = android.R.drawable.stat_sys_warning;
            rVar.f22328M.tickerText = r.b(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker));
            rVar.f22328M.when = System.currentTimeMillis();
            rVar.f22338g = pendingIntent;
            rVar.f22337f = r.b(zae);
        }
        if (PlatformVersion.isAtLeastO()) {
    ...
    public final boolean zag(Activity activity, LifecycleFragment lifecycleFragment, int i, int i9, DialogInterface.OnCancelListener onCancelListener) {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i9, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, "d"), i9), onCancelListener);
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, int i9, DialogInterface.OnCancelListener onCancelListener) {
        Dialog errorDialog = getErrorDialog(activity, i, i9, onCancelListener);
        if (errorDialog == null) {
            return false;
        }
    ...
    public Dialog getErrorDialog(Fragment fragment, int i, int i9) {
        return getErrorDialog(fragment, i, i9, (DialogInterface.OnCancelListener) null);
    }

    public Dialog getErrorDialog(Fragment fragment, int i, int i9, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, "d"), i9), onCancelListener);
    }
}
