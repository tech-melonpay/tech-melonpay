...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public zabe(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, Api.AbstractClientBuilder abstractClientBuilder, Map map, List list, List list2, Map map2, int i, int i9, ArrayList arrayList) {
        ...
        try {
            ...
            try {
                if (intValue == 3 || intValue == 1) {
                    ...
                    i = intValue;
                    Preconditions.checkArgument(z10, "Illegal sign-in mode: " + i);
                    zal(i);
                    zan();
                    this.zaj.unlock();
                    return;
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final void stopAutoManage(ActivityC0533g activityC0533g) {
