...
final class zzdm implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.x(1, FieldDescriptor.builder("key"));
    private static final FieldDescriptor zzc = a.x(2, FieldDescriptor.builder("value"));
    private static final ObjectEncoder zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzdl
    ...
    public zzdm(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private final zzdm zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) {
    ...
    private final zzdm zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z10) {
    ...
    public final zzdm zzd(FieldDescriptor fieldDescriptor, int i, boolean z10) {
        if (z10 && i == 0) {
            return this;
        }
    ...
    public final zzdm zze(FieldDescriptor fieldDescriptor, long j10, boolean z10) {
        if (z10 && j10 == 0) {
            return this;
        }
        zzdk zzj = zzj(fieldDescriptor);
