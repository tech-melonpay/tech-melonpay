...
public class Registry {
    ...
    public static class NoResultEncoderAvailableException extends MissingComponentException {
        public NoResultEncoderAvailableException(Class<?> cls) {
            super(a.l("Failed to find result encoder for resource class: ", cls, ", you may need to consider registering a new Encoder for the requested type or DiskCacheStrategy.DATA/DiskCacheStrategy.NONE if caching your transformed resource is unnecessary."));
        }
    }
    ...
    public Registry() {
        d<List<Throwable>> threadSafeList = FactoryPools.threadSafeList();
    ...
    public <X> DataRewinder<X> getRewinder(X x9) {
        return this.dataRewinderRegistry.build(x9);
    }

    public <X> Encoder<X> getSourceEncoder(X x9) {
        Encoder<X> encoder = this.encoderRegistry.getEncoder(x9.getClass());
        if (encoder != null) {
            return encoder;
        }
