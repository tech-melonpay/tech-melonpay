...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback, Animatable {
    ...
    private List<AbstractC0978c> animationCallbacks;
    ...
    @Deprecated
    public GifDrawable(Context context, GifDecoder gifDecoder, BitmapPool bitmapPool, Transformation<Bitmap> transformation, int i, int i9, Bitmap bitmap) {
        this(context, gifDecoder, transformation, i, i9, bitmap);
    }
    ...
    private void notifyAnimationEndToListeners() {
        List<AbstractC0978c> list = this.animationCallbacks;
        if (list != null) {
            int size = list.size();
    ...
    public void registerAnimationCallback(AbstractC0978c abstractC0978c) {
        ...
        this.animationCallbacks.add(abstractC0978c);
    }
    ...
    public boolean unregisterAnimationCallback(AbstractC0978c abstractC0978c) {
        List<AbstractC0978c> list = this.animationCallbacks;
        if (list == null || abstractC0978c == null) {
            return false;
        }
        return list.remove(abstractC0978c);
    }

    public GifDrawable(Context context, GifDecoder gifDecoder, Transformation<Bitmap> transformation, int i, int i9, Bitmap bitmap) {
        this(new GifState(new GifFrameLoader(Glide.get(context), gifDecoder, i, i9, transformation, bitmap)));
    }
