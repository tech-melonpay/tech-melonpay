...
public class FixedSizeDrawable extends Drawable {
    ...
    public static final class State extends Drawable.ConstantState {
        ...
        public State(Drawable.ConstantState constantState, int i, int i9) {
    ...
    public FixedSizeDrawable(Drawable drawable, int i, int i9) {
        this(new State(drawable.getConstantState(), i, i9), drawable);
    }
