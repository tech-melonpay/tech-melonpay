...
class GifFrameLoader {
    ...
    public static class DelayTarget extends CustomTarget<Bitmap> {
        ...
        public DelayTarget(Handler handler, int i, long j10) {
    ...
    public GifFrameLoader(Glide glide, GifDecoder gifDecoder, int i, int i9, Transformation<Bitmap> transformation, Bitmap bitmap) {
        this(glide.getBitmapPool(), Glide.with(glide.getContext()), gifDecoder, null, getRequestBuilder(Glide.with(glide.getContext()), i, i9), transformation, bitmap);
    }
    ...
    private static RequestBuilder<Bitmap> getRequestBuilder(RequestManager requestManager, int i, int i9) {
        return requestManager.asBitmap().apply((BaseRequestOptions<?>) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).useAnimationPool(true).skipMemoryCache(true).override(i, i9));
    }
