...
public class BitmapDrawableDecoder<DataType> implements ResourceDecoder<DataType, BitmapDrawable> {
    ...
    public Resource<BitmapDrawable> decode(DataType datatype, int i, int i9, Options options) {
        return LazyBitmapDrawableResource.obtain(this.resources, this.decoder.decode(datatype, i, i9, options));
    }
