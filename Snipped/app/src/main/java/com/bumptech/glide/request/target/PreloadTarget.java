...
public final class PreloadTarget<Z> extends CustomTarget<Z> {
    ...
    private PreloadTarget(RequestManager requestManager, int i, int i9) {
        super(i, i9);
        this.requestManager = requestManager;
    }

    public static <Z> PreloadTarget<Z> obtain(RequestManager requestManager, int i, int i9) {
        return new PreloadTarget<>(requestManager, i, i9);
    }
