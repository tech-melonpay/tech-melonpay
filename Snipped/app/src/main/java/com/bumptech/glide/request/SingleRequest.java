...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    private SingleRequest(Context context, GlideContext glideContext, Object obj, Object obj2, Class<R> cls, BaseRequestOptions<?> baseRequestOptions, int i, int i9, Priority priority, Target<R> target, RequestListener<R> requestListener, List<RequestListener<R>> list, RequestCoordinator requestCoordinator, Engine engine, TransitionFactory<? super R> transitionFactory, Executor executor) {
    ...
    private void logV(String str) {
        StringBuilder r8 = a.r(str, " this: ");
        r8.append(this.tag);
        Log.v(TAG, r8.toString());
    }

    private static int maybeApplySizeMultiplier(int i, float f10) {
    ...
    public static <R> SingleRequest<R> obtain(Context context, GlideContext glideContext, Object obj, Object obj2, Class<R> cls, BaseRequestOptions<?> baseRequestOptions, int i, int i9, Priority priority, Target<R> target, RequestListener<R> requestListener, List<RequestListener<R>> list, RequestCoordinator requestCoordinator, Engine engine, TransitionFactory<? super R> transitionFactory, Executor executor) {
        return new SingleRequest<>(context, glideContext, obj, obj2, cls, baseRequestOptions, i, i9, priority, target, requestListener, list, requestCoordinator, engine, transitionFactory, executor);
    }
    ...
    public boolean isEquivalentTo(Request request) {
        ...
        synchronized (singleRequest.requestLock) {
            try {
                i10 = singleRequest.overrideWidth;
                i11 = singleRequest.overrideHeight;
        ...
        return i == i10 && i9 == i11 && Util.bothModelsNullEquivalentOrEquals(obj, obj2) && cls.equals(cls2) && Util.bothBaseRequestOptionsNullEquivalentOrEquals(baseRequestOptions, baseRequestOptions2) && priority == priority2 && size == size2;
    }
            ...
            try {
                try {
                    ...
                    if (this.status == Status.WAITING_FOR_SIZE) {
                        ...
                        this.height = maybeApplySizeMultiplier(i9, sizeMultiplier);
                        if (z10) {
    ...
    private void onResourceReady(Resource<R> resource, R r8, DataSource dataSource, boolean z10) {
        boolean z11;
        boolean isFirstReadyResource = isFirstReadyResource();
        this.status = Status.COMPLETE;
        this.resource = resource;
        if (this.glideContext.getLogLevel() <= 3) {
            Log.d(GLIDE_TAG, "Finished loading " + r8.getClass().getSimpleName() + " from " + dataSource + " for " + this.model + " with size [" + this.width + "x" + this.height + "] in " + LogTime.getElapsedMillis(this.startTime) + " ms");
        }
        ...
        try {
            ...
            if (list != null) {
                z11 = false;
                for (RequestListener<R> requestListener : list) {
                    boolean onResourceReady = z11 | requestListener.onResourceReady(r8, this.model, this.target, dataSource, isFirstReadyResource);
                    z11 = requestListener instanceof ExperimentalRequestListener ? ((ExperimentalRequestListener) requestListener).onResourceReady(r8, this.model, this.target, dataSource, isFirstReadyResource, z10) | onResourceReady : onResourceReady;
                }
            } else {
                z11 = false;
            }
            RequestListener<R> requestListener2 = this.targetListener;
            if (requestListener2 == null || !requestListener2.onResourceReady(r8, this.model, this.target, dataSource, isFirstReadyResource)) {
                z12 = false;
            }
            if (!(z11 | z12)) {
                this.target.onResourceReady(r8, this.animationFactory.build(dataSource, isFirstReadyResource));
            }
            this.isCallingCallbacks = false;
            GlideTrace.endSectionAsync(TAG, this.cookie);
        } catch (Throwable th) {
