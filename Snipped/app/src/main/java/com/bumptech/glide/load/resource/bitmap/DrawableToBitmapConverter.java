...
final class DrawableToBitmapConverter {
    ...
    public static Resource<Bitmap> convert(BitmapPool bitmapPool, Drawable drawable, int i, int i9) {
        Bitmap bitmap;
        ...
        if (current instanceof BitmapDrawable) {
            ...
            bitmap = drawToBitmap(bitmapPool, current, i, i9);
            z10 = true;
        }
        if (!z10) {
    ...
    private static Bitmap drawToBitmap(BitmapPool bitmapPool, Drawable drawable, int i, int i9) {
        ...
        Bitmap bitmap = bitmapPool.get(i, i9, Bitmap.Config.ARGB_8888);
        try {
