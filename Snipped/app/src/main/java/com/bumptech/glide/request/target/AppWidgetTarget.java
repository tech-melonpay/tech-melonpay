...
public class AppWidgetTarget extends CustomTarget<Bitmap> {
    ...
    public AppWidgetTarget(Context context, int i, int i9, int i10, RemoteViews remoteViews, int... iArr) {
        super(i, i9);
        if (iArr.length == 0) {
    ...
    public AppWidgetTarget(Context context, int i, int i9, int i10, RemoteViews remoteViews, ComponentName componentName) {
        super(i, i9);
        this.context = (Context) Preconditions.checkNotNull(context, "Context can not be null!");
        this.remoteViews = (RemoteViews) Preconditions.checkNotNull(remoteViews, "RemoteViews object can not be null!");
