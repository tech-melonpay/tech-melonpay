...
public class UrlLoader implements ModelLoader<URL, InputStream> {
    ...
    @Override // com.bumptech.glide.load.model.ModelLoader
    public ModelLoader.LoadData<InputStream> buildLoadData(URL url, int i, int i9, Options options) {
        return this.glideUrlLoader.buildLoadData(new GlideUrl(url), i, i9, options);
    }
