...
/* compiled from: KeyValueBindingModel_.java */
/* renamed from: s6.E, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1210E extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {
    ...
    public final C1210E a(CharSequence charSequence) {
    ...
    public final C1210E b(String str) {
        onMutation();
        this.f26676a = str;
        return this;
    }

    public final C1210E c(String str) {
        onMutation();
        this.f26677b = str;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1210E) || !super.equals(obj)) {
            return false;
        }
        C1210E c1210e = (C1210E) obj;
        c1210e.getClass();
        String str = this.f26676a;
        if (str == null ? c1210e.f26676a != null : !str.equals(c1210e.f26676a)) {
            return false;
        }
        String str2 = this.f26677b;
        String str3 = c1210e.f26677b;
        return str2 == null ? str3 == null : str2.equals(str3);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_key_value;
    }
    ...
    public final String toString() {
        return "KeyValueBindingModel_{keyText=" + this.f26676a + ", valueText=" + this.f26677b + ", onClickRight=null}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        if (!(epoxyModel instanceof C1210E)) {
            setDataBindingVariables(fVar);
            return;
        }
        C1210E c1210e = (C1210E) epoxyModel;
        String str = this.f26676a;
        if (str == null ? c1210e.f26676a != null : !str.equals(c1210e.f26676a)) {
            fVar.m(84, this.f26676a);
        }
        String str2 = this.f26677b;
        if (str2 == null ? c1210e.f26677b != null : !str2.equals(c1210e.f26677b)) {
            fVar.m(154, this.f26677b);
        }
        c1210e.getClass();
    }
}
