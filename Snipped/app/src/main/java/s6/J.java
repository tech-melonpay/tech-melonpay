...
/* compiled from: LoansTabBindingModel_.java */
/* loaded from: classes2.dex */
public final class J extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<J, DataBindingEpoxyModel.DataBindingHolder> f26701a;
    ...
    public final boolean equals(Object obj) {
        ...
        return (this.f26701a == null) == (((J) obj).f26701a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_loans_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<J, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26701a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26701a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "LoansTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof J;
    }
