...
/* compiled from: InvoicesTabBindingModel_.java */
/* renamed from: s6.D, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1209D extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<C1209D, DataBindingEpoxyModel.DataBindingHolder> f26675a;

    public final C1209D a() {
        super.mo6id("invoices_tab");
        return this;
    }
    ...
    public final C1209D b(B.e eVar) {
        onMutation();
        this.f26675a = eVar;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1209D) || !super.equals(obj)) {
            return false;
        }
        return (this.f26675a == null) == (((C1209D) obj).f26675a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_invoices_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<C1209D, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26675a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26675a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "InvoicesTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof C1209D;
    }
