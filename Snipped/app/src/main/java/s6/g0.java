...
/* compiled from: SettingsTabBindingModel_.java */
/* loaded from: classes2.dex */
public final class g0 extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<g0, DataBindingEpoxyModel.DataBindingHolder> f26859a;

    public final g0 a() {
        super.mo6id("settings_tab");
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (this.f26859a == null) == (((g0) obj).f26859a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_settings_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<g0, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26859a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26859a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "SettingsTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof g0;
    }
