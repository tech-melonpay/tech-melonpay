...
/* compiled from: PaymentsTabBindingModel_.java */
/* loaded from: classes2.dex */
public final class W extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<W, DataBindingEpoxyModel.DataBindingHolder> f26740a;
    ...
    public final boolean equals(Object obj) {
        ...
        return (this.f26740a == null) == (((W) obj).f26740a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_payments_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<W, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26740a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26740a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "PaymentsTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof W;
    }
