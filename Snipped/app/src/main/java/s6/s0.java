...
public final class s0 extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (str == null ? s0Var.f27007a != null : !str.equals(s0Var.f27007a)) {
            return false;
        }
        Boolean bool = this.f27008b;
        Boolean bool2 = s0Var.f27008b;
        return bool == null ? bool2 == null : bool.equals(bool2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_wallet_header;
    }
    ...
    public final void setDataBindingVariables(F0.f fVar) {
        if (!fVar.m(148, this.f27007a)) {
            throw new IllegalStateException("The attribute title was defined in your data binding model (com.airbnb.epoxy.DataBindingEpoxyModel) but a data variable of that name was not found in the layout.");
        }
        if (!fVar.m(12, this.f27008b)) {
    ...
    public final String toString() {
        return "WalletHeaderBindingModel_{title=" + this.f27007a + ", badgeVisible=" + this.f27008b + "}" + super.toString();
    }
