...
/* compiled from: LogoutButtonBindingModel_.java */
/* loaded from: classes2.dex */
public final class K extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public View.OnClickListener f26702a;

    public final K a() {
        super.mo6id("logout_button");
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        K k3 = (K) obj;
        k3.getClass();
        return (this.f26702a == null) == (k3.f26702a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_logout_button;
    }
    ...
    public final int hashCode() {
        return (super.hashCode() * 28629151) + (this.f26702a != null ? 1 : 0);
    }
    ...
    public final void setDataBindingVariables(F0.f fVar) {
        if (!fVar.m(113, this.f26702a)) {
            throw new IllegalStateException("The attribute onClickLogout was defined in your data binding model (com.airbnb.epoxy.DataBindingEpoxyModel) but a data variable of that name was not found in the layout.");
        }
    }
    ...
    public final String toString() {
        return "LogoutButtonBindingModel_{onClickLogout=" + this.f26702a + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        ...
        K k3 = (K) epoxyModel;
        View.OnClickListener onClickListener = this.f26702a;
        if ((onClickListener == null) != (k3.f26702a == null)) {
            fVar.m(113, onClickListener);
        }
    }
