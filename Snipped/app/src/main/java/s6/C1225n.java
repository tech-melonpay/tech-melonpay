...
/* compiled from: CompanyHeaderNewBindingModel_.java */
/* renamed from: s6.n, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1225n extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {
    ...
    public final C1225n a(String str) {
        super.mo6id(str);
        return this;
    }
    ...
    public final C1225n b(Boolean bool) {
        onMutation();
        this.f26934b = bool;
        return this;
    }

    public final C1225n c(String str) {
        onMutation();
        this.f26933a = str;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1225n) || !super.equals(obj)) {
            return false;
        }
        C1225n c1225n = (C1225n) obj;
        c1225n.getClass();
        String str = this.f26933a;
        if (str == null ? c1225n.f26933a != null : !str.equals(c1225n.f26933a)) {
            return false;
        }
        Boolean bool = this.f26934b;
        Boolean bool2 = c1225n.f26934b;
        return bool == null ? bool2 == null : bool.equals(bool2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_company_header_new;
    }
    ...
    public final void setDataBindingVariables(F0.f fVar) {
        if (!fVar.m(147, this.f26933a)) {
            throw new IllegalStateException("The attribute text was defined in your data binding model (com.airbnb.epoxy.DataBindingEpoxyModel) but a data variable of that name was not found in the layout.");
        }
        if (!fVar.m(57, this.f26934b)) {
    ...
    public final String toString() {
        return "CompanyHeaderNewBindingModel_{text=" + this.f26933a + ", isFirst=" + this.f26934b + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        if (!(epoxyModel instanceof C1225n)) {
            setDataBindingVariables(fVar);
            return;
        }
        C1225n c1225n = (C1225n) epoxyModel;
        String str = this.f26933a;
        if (str == null ? c1225n.f26933a != null : !str.equals(c1225n.f26933a)) {
            fVar.m(147, this.f26933a);
        }
        Boolean bool = this.f26934b;
        Boolean bool2 = c1225n.f26934b;
        if (bool != null) {
