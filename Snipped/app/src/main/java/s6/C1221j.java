...
/* compiled from: CardCarouselItemBindingModel_.java */
/* renamed from: s6.j, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1221j extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public Integer f26903a;

    public final void a() {
        super.mo6id("ic_card_black_virt");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1221j) || !super.equals(obj)) {
            return false;
        }
        C1221j c1221j = (C1221j) obj;
        c1221j.getClass();
        Integer num = this.f26903a;
        Integer num2 = c1221j.f26903a;
        return num == null ? num2 == null : num.equals(num2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_card_carousel_item;
    }
    ...
    public final String toString() {
        return "CardCarouselItemBindingModel_{iconRes=" + this.f26903a + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        if (!(epoxyModel instanceof C1221j)) {
            setDataBindingVariables(fVar);
            return;
        }
        Integer num = this.f26903a;
        Integer num2 = ((C1221j) epoxyModel).f26903a;
        if (num != null) {
            if (num.equals(num2)) {
                return;
            }
