...
/* compiled from: LoanHeaderBindingModel_.java */
...
public final class G extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {
    ...
    public final boolean equals(Object obj) {
        ...
        String str2 = g10.f26685a;
        return str == null ? str2 == null : str.equals(str2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_loan_header;
    }
    ...
    public final String toString() {
        return "LoanHeaderBindingModel_{text=" + this.f26685a + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        ...
        String str = this.f26685a;
        String str2 = ((G) epoxyModel).f26685a;
        if (str != null) {
            if (str.equals(str2)) {
                return;
            }
