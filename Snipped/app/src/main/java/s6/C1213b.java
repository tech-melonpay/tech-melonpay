...
/* compiled from: AccountCarouselBindingModel_.java */
/* renamed from: s6.b, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1213b extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public C6.a f26782a;

    public final C1213b a(String str) {
        super.mo6id(str);
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1213b) || !super.equals(obj)) {
            return false;
        }
        C1213b c1213b = (C1213b) obj;
        c1213b.getClass();
        C6.a aVar = this.f26782a;
        C6.a aVar2 = c1213b.f26782a;
        return aVar == null ? aVar2 == null : aVar.equals(aVar2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_account_carousel;
    }
    ...
    public final int hashCode() {
        ...
        C6.a aVar = this.f26782a;
        return hashCode + (aVar != null ? aVar.f680a.hashCode() : 0);
    }
    ...
    public final String toString() {
        return "AccountCarouselBindingModel_{dataList=" + this.f26782a + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        if (!(epoxyModel instanceof C1213b)) {
            setDataBindingVariables(fVar);
            return;
        }
        C6.a aVar = this.f26782a;
        C6.a aVar2 = ((C1213b) epoxyModel).f26782a;
        if (aVar != null) {
