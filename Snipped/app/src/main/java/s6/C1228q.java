...
/* compiled from: CryptoAccountTabBindingModel_.java */
/* renamed from: s6.q, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1228q extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<C1228q, DataBindingEpoxyModel.DataBindingHolder> f26973a;

    public final C1228q a() {
        super.mo6id("crypto_account_tab");
        return this;
    }
    ...
    public final C1228q b(J7.a aVar) {
        onMutation();
        this.f26973a = aVar;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1228q) || !super.equals(obj)) {
            return false;
        }
        return (this.f26973a == null) == (((C1228q) obj).f26973a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_crypto_account_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<C1228q, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26973a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26973a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "CryptoAccountTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof C1228q;
    }
