...
/* compiled from: ExchangesTabBindingModel_.java */
/* renamed from: s6.x, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1234x extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<C1234x, DataBindingEpoxyModel.DataBindingHolder> f27037a;

    public final C1234x a() {
        super.mo6id("exchanges_tab");
        return this;
    }
    ...
    public final C1234x b(J7.a aVar) {
        onMutation();
        this.f27037a = aVar;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1234x) || !super.equals(obj)) {
            return false;
        }
        return (this.f27037a == null) == (((C1234x) obj).f27037a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_exchanges_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<C1234x, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f27037a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f27037a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "ExchangesTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof C1234x;
    }
