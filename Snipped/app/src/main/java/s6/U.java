...
/* compiled from: PaymentDetailsHeaderBindingModel_.java */
/* loaded from: classes2.dex */
public final class U extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {
    ...
    public final boolean equals(Object obj) {
        ...
        String str2 = u6.f26732a;
        return str == null ? str2 == null : str.equals(str2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_payment_details_header;
    }
    ...
    public final String toString() {
        return "PaymentDetailsHeaderBindingModel_{headerText=" + this.f26732a + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        ...
        String str = this.f26732a;
        String str2 = ((U) epoxyModel).f26732a;
        if (str != null) {
            if (str.equals(str2)) {
                return;
            }
