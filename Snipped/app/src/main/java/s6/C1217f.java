...
/* compiled from: AccountTabBindingModel_.java */
/* renamed from: s6.f, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1217f extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<C1217f, DataBindingEpoxyModel.DataBindingHolder> f26830a;

    public final C1217f a() {
        super.mo6id("account_tab");
        return this;
    }
    ...
    public final C1217f b(D6.a aVar) {
        onMutation();
        this.f26830a = aVar;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1217f) || !super.equals(obj)) {
            return false;
        }
        return (this.f26830a == null) == (((C1217f) obj).f26830a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_account_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<C1217f, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26830a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26830a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "AccountTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof C1217f;
    }
