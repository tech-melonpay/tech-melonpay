...
/* compiled from: CardsTabBindingModel_.java */
/* renamed from: s6.l, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C1223l extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {

    /* renamed from: a, reason: collision with root package name */
    public OnModelBoundListener<C1223l, DataBindingEpoxyModel.DataBindingHolder> f26919a;

    public final C1223l a() {
        super.mo6id("card_tab");
        return this;
    }
    ...
    public final C1223l b(J7.a aVar) {
        onMutation();
        this.f26919a = aVar;
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1223l) || !super.equals(obj)) {
            return false;
        }
        return (this.f26919a == null) == (((C1223l) obj).f26919a == null);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_cards_tab;
    }
    ...
    public final void handlePostBind(DataBindingEpoxyModel.DataBindingHolder dataBindingHolder, int i) {
        ...
        OnModelBoundListener<C1223l, DataBindingEpoxyModel.DataBindingHolder> onModelBoundListener = this.f26919a;
    ...
    public final int hashCode() {
        return ((super.hashCode() * 31) + (this.f26919a != null ? 1 : 0)) * 29791;
    }
    ...
    public final String toString() {
        return "CardsTabBindingModel_{}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        boolean z10 = epoxyModel instanceof C1223l;
    }
