...
/* compiled from: StatementsSelectorEmptyBindingModel_.java */
/* loaded from: classes2.dex */
public final class l0 extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder> {
    ...
    public final l0 b() {
        super.mo6id("statementsSelectorEmpty");
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        String str2 = l0Var.f26920a;
        return str == null ? str2 == null : str.equals(str2);
    }

    @Override // com.airbnb.epoxy.EpoxyModel
    public final int getDefaultLayout() {
        return R.layout.cell_statements_selector_empty;
    }
    ...
    public final void setDataBindingVariables(F0.f fVar) {
        if (!fVar.m(31, this.f26920a)) {
            throw new IllegalStateException("The attribute emptyTitle was defined in your data binding model (com.airbnb.epoxy.DataBindingEpoxyModel) but a data variable of that name was not found in the layout.");
        }
    }
    ...
    public final String toString() {
        return "StatementsSelectorEmptyBindingModel_{emptyTitle=" + this.f26920a + "}" + super.toString();
    }
    ...
    public final void setDataBindingVariables(F0.f fVar, EpoxyModel epoxyModel) {
        if (!(epoxyModel instanceof l0)) {
            setDataBindingVariables(fVar);
            return;
        }
        String str = this.f26920a;
        String str2 = ((l0) epoxyModel).f26920a;
        if (str != null) {
            if (str.equals(str2)) {
                return;
            }
